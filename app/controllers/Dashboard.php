...
class Dashboard extends MY_Controller {
    ...
    public function index() {
        ...
        $view_data["dashboards"] = $this->Dashboards_model->get_details(array("user_id" => $usuario))->result();
        $view_data["dashboard_type"] = "default";
        
        if ($users->user_type === "staff") {
          //  $this->data["show_timeline"] = get_array_value($widgets, "new_posts");
          //  $this->data["show_attendance"] = get_array_value($widgets, "clock_in_out");
          //  $this->data["show_event"] = get_array_value($widgets, "events_today");
          //  $this->data["show_project_timesheet"] = get_array_value($widgets, "timesheet_statistics");
          //  $this->data["show_income_vs_expenses"] = get_array_value($widgets, "income_vs_expenses");
          //  $this->data["show_invoice_statistics"] = get_array_value($widgets, "invoice_statistics");
          //  $this->data["show_ticket_status"] = get_array_value($widgets, "ticket_status");
          //  $this->data["show_clock_status"] = get_array_value($widgets, "clock_status");
            $this->rander('dashboards/index', $meta, $this->data);
