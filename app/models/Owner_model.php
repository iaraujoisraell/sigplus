...
(SELECT count(*) as concluido FROM sig_planos p where projeto = $projeto_atual_id and p.empresa = $empresa and status = 'PENDENTE' AND data_termino < '$date_hoje') as atrasado
