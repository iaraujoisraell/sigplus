...
class MY_Controller extends CI_Controller {
    ...
    function page_construct($page, $meta = array(), $data = array()) {
        ...
        $this->load->view($this->theme . 'footer_default');
    }
    
    function page_construct_networking($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
     //   $meta['info'] = $this->site->getNotifications();
     ...
     //   $meta['ip_address'] = $this->input->ip_address();
       ...
       // $meta['qty_alert_num'] = $this->site->get_total_qty_alerts();
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_networking', $meta);
        $this->load->view($this->theme . $page, $data); 
        $this->load->view($this->theme . 'footer_welcome');
        
    }
    
    function page_construct_networking_nova_acao($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
        $meta['Settings'] = $data['Settings'];
        ...
        $this->load->view($this->theme . 'header_networking', $meta);
        $this->load->view($this->theme . $page, $data); 
        $this->load->view($this->theme . 'footer_welcome_nova_acao');
        
    }
    
    // networking home
    function page_construct_networking_home($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
     //   $meta['info'] = $this->site->getNotifications();
    ...
    function page_construct_networking_pa($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
     //   $meta['info'] = $this->site->getNotifications();
     ...
     //   $meta['ip_address'] = $this->input->ip_address();
       ...
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_networking', $meta);
        $this->load->view($this->theme . $page, $data); 
        $this->load->view($this->theme . 'footer_networking_pa');
        
    }
    
     function page_construct_owner($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
      //  $meta['info'] = $this->site->getNotifications();
      ...
      //  $meta['ip_address'] = $this->input->ip_address();
       ...
       // $meta['qty_alert_num'] = $this->site->get_total_qty_alerts();
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_owner', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_lte');
          //$this->load->view($this->theme . 'footer');
        
    }
    
    function page_construct_project($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
      //  $meta['info'] = $this->site->getNotifications();
    ...
    function page_construct_ata($page, $meta = array(), $data = array()) {
       ...
       // $meta['qty_alert_num'] = $this->site->get_total_qty_alerts();
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_project_ata', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_projeto_ata');
          //$this->load->view($this->theme . 'footer');
        
    }
    
    function page_construct_project_collapse($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
      //  $meta['info'] = $this->site->getNotifications();
    ...
    function page_construct_admin($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
    ...
    function page_construct_project_home($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
       // $meta['info'] = $this->site->getNotifications();
       ...
       // $meta['qty_alert_num'] = $this->site->get_total_qty_alerts();
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_project_home', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_lte_project_home');
          //$this->load->view($this->theme . 'footer');
        
    }
    
    function page_construct_project_calendario($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
       // $meta['info'] = $this->site->getNotifications();
      ...
      //  $meta['ip_address'] = $this->input->ip_address();
       ...
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_project', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_projeto_calendario');
          //$this->load->view($this->theme . 'footer');
        
    }
    
     function page_construct_project_calendario_welcome($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
       // $meta['info'] = $this->site->getNotifications();
      //  $meta['events'] = $this->site->getUpcomingEvents();
       ...
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_networking', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_welcome_calendario');
          //$this->load->view($this->theme . 'footer');
    ...
    function page_construct_owner_sortable($page, $meta = array(), $data = array()) {
        $meta['message'] = isset($data['message']) ? $data['message'] : $this->session->flashdata('message');
        $meta['error'] = isset($data['error']) ? $data['error'] : $this->session->flashdata('error');
        $meta['warning'] = isset($data['warning']) ? $data['warning'] : $this->session->flashdata('warning');
        $meta['info'] = $this->site->getNotifications();
       ...
       // $meta['qty_alert_num'] = $this->site->get_total_qty_alerts();
       // $meta['exp_alert_num'] = $this->site->get_expiring_qty_alerts();
        $this->load->view($this->theme . 'header_owner_sortable', $meta);
        $this->load->view($this->theme . $page, $data);    
        $this->load->view($this->theme . 'footer_sortable');
          //$this->load->view($this->theme . 'footer');
