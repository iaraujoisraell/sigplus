...
class Workflow extends ClientsController {
    ...
    public function index() {
        ...
        $_d['categorias'] = $this->Categorias_campos_model->get_categorias_with_ra('workflow', 'portal_paciente');
        ...
        $_d["info_perfil"] = $this->Clients_model->get_paciente_portal($id_client);


        $this->load->view('portal_paciente/workflow/index.php', $_d);
    }
    ...
    public function add() {
        ...
        if ($id) {
            redirect(base_url('portal_paciente/workflow/index'));
        }
    }
    ...
    public function workflow($id) {
        ...
        $this->load->view('portal_paciente/workflow/single.php', $_d);
    }
    ...
    public function finish_external_request($id = '') {
        ...
        redirect(base_url() . 'portal_paciente/workflow/workflow/' . $id);
    }
}
