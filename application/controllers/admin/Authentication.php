...
class Authentication extends App_Controller {
    ...
    public function index() {
        ...
        if (!empty($server_name) && strpos($server_name, '.sigplus.app.br') !== false) {
            $company = strstr($server_name, '.sigplus.app.br', true);
        }
//        echo $company;
//        exit;
        if ($company) {
    ...
    public function admin_unimed() {
        ...
        if ($this->input->post()) {
            ...
            curl_setopt_array($ch, array(
                ...
                CURLOPT_TIMEOUT => 60, // Tempo máximo de espera em segundos
            ...
            if ($response == true) {
                ...
                redirect(admin_url('authentication/admin_unimed?FAIL=1'));
            }
