...
//require_once base_url().'assets/TWW/TWWAutoload.php';
...
define('TWW_USER_PASSWORD', 'Unimed@2024');
///use TWWServiceEnvia;
class Authentication_old extends ClientsController
{
    public function __construct()
    {
        parent::__construct();
        //echo APPPATH .'assets/TWW/TWWAutoload.php'; exit;
    ...
    public function index()
    {
        ...
        $mensagem = 'a';
        $referencia = 'teste24';
        $resultado = $this->EnviaSMSTWW($numero, $mensagem, $referencia);
        echo $resultado; exit;
        if ($resultado) {
    ...
    function EnviaSMSTWW($numero, $mensagem, $referencia){
        ...
        try {
            ...
            $resultado = $tWWServiceEnvia->EnviaSMS(new TWWStructEnviaSMS('UNIMEDAM', 'Unimed@2024', $referencia, '55'.$numero, $mensagem));
