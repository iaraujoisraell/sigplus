...
class Dashboard extends ClientsController {
    ...
    public function index($master = '')
    {
       ...
       // var_dump($this->session->userdata('portal_quick_access')); exit;

        // 🚨 REGRA DO ACESSO RÁPIDO
        if ($this->session->userdata('portal_quick_access')) {
            redirect(base_url('portal/financeiro'));
        }
    ...
    public function single($id) {
        ...
        if ($id == '1') {
            ...
            $view_data['img'] = 'noticia_md_5.jpeg';
            $view_data['titulo'] = 'Atenção Beneficiário';
            $view_data['desc'] = 'Acesso aos boletos.';
        }


        $view_data['imgs'] = ['noticia_md_1.jpeg', 'noticia_md_2.jpg', 'noticia_md_3.jpg', 'noticia_md_4.jpeg', 'noticia_md_5.jpeg'];
