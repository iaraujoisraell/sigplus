...
*
*/
define('APP_BASE_URL', 'https://portalcliente.app.br/admin');
...
*/
define('APP_ENC_KEY', '450ba03ef17ce23da918045744422e72');
...
define('APP_DB_HOSTNAME', '54.158.243.192');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'wwsigp_sig');
//define('APP_DB_USERNAME', 'sigplusapp_admin');  VPS
//define('APP_DB_USERNAME', 'root');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Sigplus*2024');
//define('APP_DB_PASSWORD', 'Sigplus#2023');
//define('APP_DB_PASSWORD', 'W3b#Un1m3d');
/**
 * The name of the database you want to connect to
 */
 define('APP_DB_NAME_DEFAULT', 'wwsigp_sigplus');
