<?php
/**
 * File for class TWWStructEnviaSMSTIMResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSTIMResult originally named EnviaSMSTIMResult
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSTIMResult extends TWWWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for EnviaSMSTIMResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructEnviaSMSTIMResult::setAny()
