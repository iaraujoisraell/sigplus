...
class App_tabs
{
    ...
    public function add_medico_profile_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'medico_profile');
        return $this;
    }

    public function get_medico_profile_tabs()
    {
        return $this->get('medico_profile');
    }
    
    public function add_financeiro_profile_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'financeiro_profile');
        return $this;
    }
    
    public function get_financeiro_profile_tabs()
    {
        return $this->get('financeiro_profile');
    }
    
    public function add_intranet_profile_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'intranet_profile');
        return $this;
    }
    
    public function get_intranet_profile_tabs()
    {
        return $this->get('intranet_profile');
    }
    
     public function add_unidade_hospitalar_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'unidade_hospitalar');
        return $this;
    }
    
    public function get_unidade_hospitalar_tabs()
    {
        return $this->get('unidade_hospitalar');
    }
