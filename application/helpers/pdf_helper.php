...
function escalas_pdf($escala, $tag = '')

{

   

    return app_pdf('escala', LIBSPATH . 'pdf/Rel_escala_pdf', $escala, $tag);

}



function frequencias_pdf($frequencia, $tag = '')

{

   

    return app_pdf('frequencia', LIBSPATH . 'pdf/Rel_frequencia_pdf', $frequencia, $tag);

}

function rel_geral_pdf($relatorio_geral, $tag = '')
{
   
    return app_pdf('rel_geral', LIBSPATH . 'pdf/Rel_geral_pdf', $relatorio_geral, $tag);
}



function payment_recibo_pdf($payment, $invoice_data, $tag = '')

{

    return app_pdf('payment', LIBSPATH . 'pdf/Payment_pdf_recibo', $payment, $invoice_data, $tag);
