...
$aColumns = array_merge($aColumns, [
    ...
    'tbl_intranet_api.name as api',
    db_prefix() . '_intranet_api.id as id2'
    
        ]);
$sIndexColumn = db_prefix() . '_intranet_acess_type.id';
$sTable = db_prefix() . '_intranet_acess_type';

$join = ['left join tbl_intranet_api on tbl_intranet_api.id = tbl_intranet_acess_type.api_id'];
