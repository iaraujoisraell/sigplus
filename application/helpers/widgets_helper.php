...
function get_intranet_widgets()
{
    $widgets = [
        [
            'path'      => 'gestao_corporativa/intranet/widgets/destaques',
            'container' => 'destaques',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/banner',
            'container' => 'banner',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/links',
            'container' => 'links',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/arquivos',
            'container' => 'arquivos',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/calendario',
            'container' => 'calendario',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/aniversariantes',
            'container' => 'aniversariantes',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/noticias',
            'container' => 'noticias',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/cards',
            'container' => 'cards',
        ],
        [
            'path'      => 'gestao_corporativa/intranet/widgets/posts',
            'container' => 'posts',
        ],
        [
            'path'      => 'admin/dashboard/widgets/tickets_chart',
...
function render_intranet_widgets($container)
{
    $widgets = get_intranet_widgets();
