...
/*
    ...
    if (has_permission_intranet('terceiros', '', 'view') || is_admin()) {
        $CI->app_tabs->add_intranet_profile_tab('terceiros', [
            'name' => 'Empresas Tercerizadas',
            'icon' => 'fa fa-building-o',
            'view' => 'gestao_corporativa/intranet/cadastros/groups/terceiros',
            'position' => 145,
        ]);
    }
    ...
    if (has_permission_intranet('documentos_settings', '', 'view') || is_admin()) {
