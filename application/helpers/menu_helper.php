...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (has_permission('dashboard_gestao', '', 'view')) {
    $CI->app_menu->add_sidebar_menu_item('dashboard_gerencia', [
        'name'     => _l('dashboard_gestao'),
        'href'     => admin_url('dashboard/dashboard_gestao'),
        'position' => 1,
    ...
    $CI->app_menu->add_sidebar_menu_item('busca_ativa', [
        'name'     => 'Busca Ativa',
    ...
    if (has_permission('items', '', 'view')) {
     ...
     if (has_permission('items', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('sales', [
                'slug'     => 'tabela_preco',
                'name'     => _l('tabela_preco'),
                'href'     => admin_url('tabela_preco'),
                'position' => 35,
        ]);
    }
    if (has_permission('items', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('sales', [
                'slug'     => 'tabela_preco_repasse',
                'name'     => _l('tabela_preco_repasse'),
                'href'     => admin_url('tabela_preco_repasse'),
                'position' => 40,
        ]);
    }
   ...
   if (has_permission('faturamento_menu', '', 'view')) {
    ...
    if (has_permission('faturamento_menu', '', 'controle_guia')) {
        $CI->app_menu->add_sidebar_children_item('faturamento', [
                'slug'     => 'Controle de Guias',
                'name'     => 'Controle de Guias',
                'href'     => admin_url('producao_auditoria/controle_Guias'),
                'position' => 5,
        ]);
    }
    ...
    /************************ T E S O U R A R I A ******************************/
     ...
     $CI->app_menu->add_sidebar_menu_item('tesouraria', [
            'collapse' => true,
            'name'     => _l('tesouraria'),
            'position' => 25,
            'icon'     => 'fa fa-money',
    ...
    if ((has_permission('invoices', '', 'view') || has_permission('invoices', '', 'view_own'))
         || (staff_has_assigned_invoices() && get_option('allow_staff_view_invoices_assigned') == 1)) {
        $CI->app_menu->add_sidebar_children_item('tesouraria', [
                'slug'     => 'invoices',
                'name'     => _l('invoices'),
                'href'     => admin_url('invoices'),
                'position' => 5,
    ...
    if (has_permission('tesouraria', '', 'repasses')) {
        $CI->app_menu->add_sidebar_children_item('tesouraria', [
                'slug'     => 'repasses',
                'name'     => _l('repasses'),
                'href'     => admin_url('repasses'),
                'position' => 20,
        ]);
    }
    
    /************* F I M  * *  T E S O U R A R I A ******************************/
...
/*
    ...
    if (is_staff_member()) {
        $CI->app_menu->add_sidebar_children_item('crm', [
                'name'     => 'Campanhas',
                'href'     => admin_url('leads/campanhas'),
    ...
    if (has_permission('reports', '', 'view')) {
        ...
        $CI->app_menu->add_sidebar_children_item('reports', [
                'slug'     => 'sales-tesouraria-reports',
                'name'     => _l('als_reports_age_submenu'),
                'href'     => admin_url('reports/sales_agendamento'),
                'position' => 5,
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
                'slug'     => 'sales-tesouraria-reports',
                'name'     => _l('als_reports_tes_submenu'),
                'href'     => admin_url('reports/sales_tesouraria'),
                'position' => 10,
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
                'slug'     => 'sales-faturamento-reports',
                'name'     => _l('als_reports_fat_submenu'),
                'href'     => admin_url('reports/sales_faturamento'),
                'position' => 15,
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
                'slug'     => 'sales-reports',
    ...
    // Setup MEDICOS
    if (has_permission('medico', '', 'cadastro')) {
        $CI->app_menu->add_setup_menu_item('medicos', [
                    'name'     => _l('als_medicos'),
                    'href'     => admin_url('medicos'),
                    'position' => 10,
            ]);
    }
