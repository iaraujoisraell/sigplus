...
function get_mime_class_simple($part1)
{
    if (empty($part1) || is_null($part1)) {
        return 'mime mime-file';
    }
    // Image
    if ($part1 == 'image') {
    ...
    elseif ($part1 == 'text') {
        ...
        // Ilustrator
        elseif ($part1 == 'illustrator') {
            return 'mime mime-illustrator';
        }
        // Zip
        elseif ($part1 == 'zip' || $part1 == 'gzip' || strpos($part1, 'tar') !== false || strpos($part1, 'compressed') !== false) {
            return 'mime mime-zip';
        }
        // PowerPoint
        elseif (strpos($part1, 'powerpoint') !== false || strpos($part1, 'presentation') !== false) {
            return 'mime mime-powerpoint ';
        }
        // Excel
        elseif (strpos($part1, 'excel') !== false || strpos($part1, 'sheet') !== false) {
            return 'mime mime-excel';
        }
        // Word
        elseif ($part1 == 'msword' || $part1 == 'rtf' || strpos($part1, 'document') !== false) {
            return 'mime mime-word';
        }
