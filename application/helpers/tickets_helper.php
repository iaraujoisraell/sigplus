...
function get_ro_status($id) {
    if ($id == '' || is_null($id)) {
        return '';
    }
    if($id == 1){
        $line = ['id' => '1', 'label' => 'ABERTO', 'color' => '#ff2d42', 'class' => 'danger'];
    } elseif($id == 2){
        $line = ['id' => '2', 'label' => 'EM PROGRESSO', 'color' => '#03a9f4', 'class' => 'info'];
    } elseif($id == 3){
        $line = ['id' => '3', 'label' => 'FINALIZADO', 'color' => '#84c529', 'class' => 'success'];
    } else{
        $line = ['id' => '4', 'label' => 'CANCELADO', 'color' => '#c0c0c0', 'class' => 'secondary'];
    }
