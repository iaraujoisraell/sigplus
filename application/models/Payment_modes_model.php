...
class Payment_modes_model extends App_Model
{
    ...
    public function get_tipo_pagamento_all()
    {
        $sql = "SELECT * FROM tblpayment_modes_tipo ";
         
       $result = $this->db->query($sql)->result_array();
        return $result;
    }
    
    public function get_tipo_pagamento($id = '')
    {
        $empresa_id = $this->session->userdata('empresa_id');
         $sql = "SELECT t.id as tipo FROM tblpayment_modes m "
