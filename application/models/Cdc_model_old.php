...
class Cdc_model extends App_Model {
    ...
    public function get_documento($id = 0) {
        ...
        $sql = "SELECT $tbl_documento.*, $tbl_categoria.titulo as nome_categoria, $tbl_categoria.responsavel as responsavel FROM $tbl_documento "
    ...
    public function get_categorias() {
        ...
        $sql = "SELECT * FROM $tbl_categoria "
                ...
                . "AND $tbl_deps.departmentid in(SELECT departmentid from tblstaff_departments where tblstaff_departments.staffid = " . get_staff_user_id() . ")";
        //echo $sql; exit;
