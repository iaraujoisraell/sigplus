...
class Proposals_model extends App_Model
{
    ...
    public function copy($id)
    {
        ...
        foreach ($proposal->items as $item) {
            ...
            $insert_data['newitems'][$key]['medicoid']         = $item['medicoid'];
            $insert_data['newitems'][$key]['item_id']          = $item['item_id'];
            $insert_data['newitems'][$key]['desconto_valor']   = $item['desconto_valor'];
            $insert_data['newitems'][$key]['rate_desconto']    = $item['rate_desconto'];
            $insert_data['newitems'][$key]['valor_medico']     = $item['valor_medico'];
