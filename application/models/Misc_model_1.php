...
class Misc_model extends App_Model
{
     ...
     * HISTÓRICO
     */
     public function get_historico($rel_id, $rel_type)
    {
    ...
    public function add_historico($data, $rel_type, $rel_id)
    {
    ...
    {
        $this->db->select(' * ,'.db_prefix() . 'medicos_procedimentos.id as mp_id, '.db_prefix() . 'items.id as items_id');
    ...
    public function atualiza_repasses_medicos($medicoid)
    {
       $sql = "SELECT t.* FROM tblitemable t
                inner join tblinvoices i on i.id = t.rel_id and rel_type = 'invoice'
                where i.date between '2021-02-01' and '2021-02-28' and valor_medico is null
