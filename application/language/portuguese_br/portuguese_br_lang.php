...
$lang['invoice_table_medico_heading'] = 'Médico';

$lang['estimate_table_medico_heading'] = 'Médico';
...
$lang['dashboard_gestao'] = 'Dashboard Gestao';
...
$lang['invoice_add_edit_admin_note'] = 'Observações';
...
$lang['invoice_payments_received_resumo_forma_pagamento'] = 'Pagamentos Recebidos Resumo - Forma Pagamento';
...
$lang['als_medicos'] = 'Médicos';

$lang['als_tasks'] = 'Ações';
...
$lang['als_reports_age_submenu'] = 'Agendamentos';

$lang['als_reports_tes_submenu'] = 'Tesouraria';

$lang['als_reports_fat_submenu'] = 'Faturamento';
...
$lang['new_task'] = 'Nova Ação';

$lang['tasks'] = 'Ações';

$lang['task'] = 'Ação';

$lang['task_lowercase'] = 'ação';

$lang['comment_string'] = 'Comentário';

$lang['task_marked_as_complete'] = 'Ação marcada como completa';

$lang['task_follower_removed'] = 'Seguidor da ação removido com sucesso';

$lang['task_assignee_removed'] = 'Destinatário da ação removido com sucesso';

$lang['task_no_assignees'] = 'Nenhum destinatário para essa ação';

$lang['task_no_followers'] = 'Nenhum seguidor para essa ação';
...
$lang['task_single_assignees_select_title'] = 'Atribuir a ação a';
...
$lang['task_add_edit_description'] = 'O que';

$lang['task_add_edit_what'] = 'Por que';

$lang['task_add_edit_where'] = 'Onde';

$lang['task_add_edit_how'] = 'Como';

$lang['task_add_edit_justify'] = 'Justificativa';

$lang['task_add_edit_ob'] = 'Objetivo';

$lang['task_add_edit_cost'] = 'Custo'; //custo

$lang['task_add_edit_indicators'] = 'Indicadores'; //meta

$lang['task_add_edit_goal'] = 'Meta'; //indicadores





$lang['task_add_what'] = 'Adicionar o porquê';

$lang['task_add_where'] = 'Adicionar onde';

$lang['task_add_how'] = 'Adicionar como';

$lang['task_add_justify'] = 'Adicionar justificativa';

$lang['task_add_ob'] = 'Adicionar objetivo';

$lang['task_add_cost'] = 'Adicionar custo';

$lang['task_add_indicators'] = 'Adicionar indicadores';

$lang['task_add_goal'] = 'Adiciocnar meta';

$lang['task_no_description'] = 'Descrição não infomada.';

$lang['task_no_what'] = 'Não informado o porquê.';

$lang['task_no_where'] = 'Não informado onde.';

$lang['task_no_how'] = 'Não informado como.';

$lang['task_no_justify'] = 'Justificativa não informada.';

$lang['task_no_ob'] = 'Objetivo não informado.';

$lang['task_no_cost'] = 'Custo não informado.';

$lang['task_no_indicators'] = 'Indicadores não informados.';

$lang['task_no_goal'] = 'Meta não informada.';
...
$lang['payment_numero_cartao'] = 'Número do Cartão';

$lang['payment_codigo_autorizacao'] = 'Código Autorização';

$lang['payment_numero_parcela'] = 'Número de Parcelas';

$lang['payment_numero_nf'] = 'Número Nota Fiscal';

$lang['nota_fiscal'] = 'Nota Fiscal';
...
$lang['task_is_private'] = 'Ação privada';
...
$lang['task_unmarked_as_complete'] = 'Ação desmarcada como concluída';

$lang['task_relation'] = 'Relacionado';

$lang['task_public'] = 'Público';

$lang['task_public_help'] = 'Se você definir essa ação como pública ela será visível para todos os membros da equipe. Caso contrário, será apenas visível para os membros que são remetentes, seguidores, criadores ou administradores';
...
$lang['show_tasks_on_calendar'] = 'Ações';
...
$lang['proposal_related'] = 'Cliente Relacionado';
...
$lang['home_my_tasks'] = 'Minhas Ações';
...
$lang['not_task_added_you_as_follower'] = 'adicionou você como seguidor na ação %s ...';

$lang['not_task_added_someone_as_follower'] = 'adicionou %s como seguidor na ação %s ...';

$lang['not_task_added_himself_as_follower'] = 'adicionou ele mesmo como seguidor na ação %s ...';

$lang['not_task_assigned_to_you'] = 'atribuida uma ação para você %s ...';

$lang['not_task_assigned_someone'] = 'atribuida %s para ação %s ...';

$lang['not_task_will_do_user'] = 'fará a ação %s ...';

$lang['not_task_new_attachment'] = 'Novo Anexo Adicionado';

$lang['not_task_marked_as_complete'] = 'ação marcada como completa %s';

$lang['not_task_unmarked_as_complete'] = 'ação desmarcada como completa %s';
...
$lang['invoice_estimate_activity_updated_item_desconto'] = 'desconto do item atualizada de %s para %s';
...
$lang['top_search_placeholder_fatura'] = 'Procurar Fatura...';
...
$lang['tasks_view_assigned_to_user'] = 'Ações atribuídas a mim';

$lang['tasks_view_follower_by_user'] = 'Ações que eu estou seguindo';

$lang['no_tasks_found'] = 'Nenhuma Ação encontrada';
...
$lang['report_valor_total_fatura'] = 'Valor Fatura';
...
$lang['settings_client_staff_add_edit_delete_task_comments_first_hour'] = 'Permitir ao cliente/equipe adicionar/editar comentários de ações, apenas na primeira hora? (Não aplicado aos administradores)';
...
$lang['task_is_billed'] = 'Esta ação é cobrada na fatura com o número %s';
...
$lang['invoice_task_item_project_tasks_not_included'] = 'Ações do Projeto não estão incluidas nessa lista.';
...
$lang['bill_tasks'] = 'Ações da Conta';
...
$lang['timers_started_confirm_logout'] = 'Cronometro de ações encontrados iniciados!<br /> Você tem certeza que quer fazer logout sem parar os cronometros?';
...
$lang['cant_change_billing_type_billed_tasks_found'] = 'Você não pode alterar o tipo de fatura. Ações já faturadas encontrada para esse projeto.';
...
$lang['project_mark_all_tasks_as_completed'] = 'Marcar todas as ações como concluidas e parar todos os cronometros (Nenhum notificação enviada para os membros do projeto)';

$lang['project_not_started_status_tasks_timers_found'] = 'Cronometros das ações encontrado para esse projeto, mas o projeto está com Status de Não Iniciado. Recomedado alterar o status do Projeto para Em Progresso';
...
$lang['project_task_assigned_to_user'] = 'Ações atribuidas a você';
...
$lang['project_billing_type_project_task_hours'] = 'Horas das ações';

$lang['project_billing_type_project_task_hours_hourly_rate'] = 'Com base na ação RTU taxa horária';
...
$lang['milestone_no_tasks_found'] = 'Nenhuma Ação Encontrada';
...
$lang['project_open_tasks'] = 'Abrir Ações';
...
$lang['project_timesheet_task'] = 'Ação';
...
$lang['invoice_project_data_task_per_item'] = 'Ação por item';
...
$lang['invoice_project_projectname_taskname'] = 'Nome do projeto + Nome da Ação';

$lang['invoice_project_all_tasks_total_logged_time'] = 'Todas as ações + total de tempo logado por ação';
...
$lang['project_setting_view_task_total_logged_time'] = 'visualizar o tempo total logado da ação';

$lang['project_setting_view_task_comments'] = 'visualizar comentários da ação';

$lang['project_setting_upload_files'] = 'atualizar os arquivos';

$lang['project_setting_view_task_checklist_items'] = 'visualizar os itens da lista de ações';

$lang['project_setting_view_task_attachments'] = 'visualizar anexos das ações';

$lang['project_setting_upload_on_tasks'] = 'enviar anexos nas ações';

$lang['project_setting_open_discussions'] = 'abrir discussões';

$lang['project_setting_comment_on_tasks'] = 'comentar nas ações do projeto';

$lang['project_setting_view_tasks'] = 'visualizar ações';
...
$lang['project_activity_marked_all_tasks_as_complete'] = 'Marcou todas as ações como completas';

$lang['project_activity_recorded_timesheet'] = 'Gravou no quadro de tempo';

$lang['project_activity_task_name'] = 'Ação:';
...
$lang['project_activity_task_marked_complete'] = 'Ação marcada como completa';

$lang['project_activity_task_unmarked_complete'] = 'Ação desmarcada como completa';

$lang['project_activity_task_deleted'] = 'Ação deletada';

$lang['project_activity_new_task_comment'] = 'Comentou na ação';

$lang['project_activity_new_task_attachment'] = 'Atualizou o anexo na ação';

$lang['project_activity_new_task_assignee'] = 'Adicionou novo remetente a açãp';

$lang['project_activity_task_assignee_removed'] = 'Removeu remetente da ação';
...
$lang['tasks_reminder_notification_before_help'] = 'Notificar os destinatários da ação com prazo de entrega antes de X dias. A notificação/e-mail é enviado somente para os destinatários.';

$lang['tasks_reminder_notification_before'] = 'Lembrete sobre prazo da ações antes de (Dias)';

$lang['not_task_deadline_reminder'] = 'Atenção! O prazo da ação está acabando! Clique para ver.';

$lang['dt_length_menu_all'] = 'Todos';

$lang['task_not_finished'] = 'Incompleto';

$lang['task_billed_cant_start_timer'] = 'Ação faturada. Cronômetro não pode ser recomeçado';
...
$lang['project_invoice_task_no_timers_found'] = 'Nenhum cronômetro encontrado para esta ação';

$lang['invoice_project_tasks_not_started'] = 'Ainda não iniciado | Data de início: %s.';

$lang['invoice_project_see_billed_tasks'] = 'Ver ações que serão cobradas nesta fatura';

$lang['invoice_project_all_billable_tasks_marked_as_finished'] = 'Todas as ações faturadas serão marcadas como acabadas';

$lang['invoice_project_nothing_to_bill'] = 'Não há ações para faturar. Fique a vontade para adicionar o que quiser nos itens da fatura.';

$lang['invoice_project_start_date_tasks_not_passed'] = 'Ações com data de início no futuro não podem ser cobradas';
...
$lang['project_invoice_timers_started'] = 'Os cronômetros da ação encontrada estão executando as ações faturáveis. Fatura não pode ser criada. Por favor, pare o cronômetro da ação, para criar fatura.';

$lang['task_start_timer_only_assignee'] = 'Você precisa estar atribuído a esta ação, para iniciar o cronômetro!';
...
$lang['project_invoice_select_all_tasks'] = 'Selecionar todas as ações';
...
$lang['show_all_tasks_for_project_member'] = 'Permitir ao Colaborador a ver todas as ações, relacionadas a projetos que ele faz parte? (inclui não Colaboradores)';
...
$lang['detailed_overview'] = 'Visão geral das ações';
...
$lang['task_copied_successfully'] = 'Ação copiada com sucesso';

$lang['failed_to_copy_task'] = 'Falha ao copiar ação';
...
$lang['back_to_tasks_list'] = 'Voltar a lista de ações';
...
$lang['calculate_progress_through_tasks'] = 'Calcular progresso através de ações';
...
$lang['not_task_new_comment'] = 'comentou a ação %s';
...
$lang['help_tasks_permissions'] = 'Se marcar essa opção, irá permitir que os membros da equipe vejam TODAS as ações, sem exceção. Se você só quer que eles visualizem apenas as ações as quais eles são atribuídos ou seguindo, não marque essa opção.';
...
$lang['tasks_not_finished'] = 'Ações não Terminadas';
...
$lang['task_assigned_from'] = 'Esta ação está atribuída a você por %s';
...
$lang['upcoming_tasks'] = 'Próximas Ações';
...
$lang['staff_total_task_assigned'] = 'Total de ações atribuídas';

$lang['staff_total_comments_on_tasks'] = 'Comentários nas ações';

$lang['project_members_overview'] = 'Visão geral dos membros do projeto';

$lang['project_milestones_overview'] = 'Visão geral das etapas';

$lang['total_tasks_in_milestones'] = 'Total de ações atribuídas';
...
$lang['task_info'] = 'Informações da Ação';
...
$lang['todays_tasks'] = 'Ações de hoje';

$lang['payment_mode_invoices_only'] = 'Apenas Faturas';

$lang['payment_mode_expenses_only'] = 'Apenas Despesas';

$lang['task_no_checklist_items_found'] = 'Itens da lista de verificação não foram encontrados para esta ação';
...
$lang['recurring_task'] = 'Ação Recorrente';
...
$lang['add_task_timer_started_warning'] = 'Pare o cronômetro, iniciado atualmente para esta ação, para ser capaz de adicionar um novo cronômetro, manualmente.';
...
$lang['task_marked_as_success'] = 'Ação marcada como %s com sucesso!';

$lang['search_tasks'] = 'Buscar Ações';

$lang['tasks_kanban_limit'] = 'Limite de linhas, por status, de ações no modo Kan Ban (Modo Cartão)';
...
$lang['total_tasks_deleted'] = 'Total de Ações Deletadas: %s';
...
$lang['task_hourly_rate'] = 'Valor da ação, por hora';
...
$lang['convert_to_task'] = 'Converter para ação';
...
$lang['permission_tasks_based_on_assignee'] = 'Se o colaborador não tiver permissão para ver Globalmente, será exibido apenas as ações onde o membro da equipe é seguidor, atribuído ou se a ação estiver como Pública. Outra opção é Configurar da seguinte forma -> Configurações-> Ações -> Permitir que todos os colaboradores possam ver todas as ações, relacionadas a projetos. Defina para SIM, quando a ação estiver vinculada ao projeto.';
...
$lang['new_task_assigned_non_user'] = 'Nova ação %s foi atribuída a você';
...
$lang['create_the_duplicate_form_data_as_task'] = 'Criar %s Dados duplicados, para a ação, e atribuir a um colaborador responsável';
...
$lang['search_ajax_empty'] = 'CLIENTE';
...
$lang['task_edit_delete_timesheet_notice'] = 'O Quadro de Tempo da ação é %s. Você não pode %s o quadro de tempo.';
...
$lang['not_activity_new_task_created'] = 'Nova ação Criada - %s';
...
$lang['new_task_auto_assign_current_member'] = 'Atribuir automaticamente o criador da ação, quando nova ação for criada';

$lang['new_task_auto_assign_current_member_help'] = 'Não se aplica se a ação estiver vinculada ao projeto e o criador não for membro do projeto';

$lang['copy_project_tasks_status'] = 'Status das ações';

$lang['tasks_summary'] = 'Resumo das Ações';
...
$lang['group_by_task'] = 'Grupo por Ação';
...
$lang['task_is_overdue'] = 'Esta ação está atrasada';
...
$lang['tasks_bull_actions_assign_notice'] = 'Se a ação estiver vinculada ao projeto e o membro da equipe ao qual você está atribuindo a ação não for membro do projeto, essa equipe será automaticamente adicionada como membro.';
...
$lang['task_users_working_on_tasks_multiple'] = 'Atualmente, %s está trabalhando nessa ação';

$lang['task_users_working_on_tasks_single'] = 'Atualmente %s está trabalhando nesta ação';
...
$lang['exclude_completed_tasks'] = 'Excluir ações concluídas';
...
$lang['task_add_description'] = 'Adicionar o que';

$lang['project_setting_create_tasks'] = 'criar ações';

$lang['project_setting_edit_tasks'] = 'editar ações (somente ações criadas a partir do contato)';

# Version 1.9.2

$lang['items_report'] = 'Relatório de Procedimentos';

$lang['producao_medico_report'] = 'Relatório de Produção Medica';
...
$lang['timer_started_change_status_in_progress'] = 'Alterar o status da ação para Em andamento no início do cronômetro (aplicável somente se o status da ação for Não iniciado)';
...
$lang['default_task_status'] = 'Status padrão quando uma nova ação é criada';
...
$lang['hide_tasks_on_main_tasks_table'] = 'Ocultar ações do projeto na tabela de ações principais (área administrativa)';
...
$lang['new_task_auto_follower_current_member'] = 'Adicionar automaticamente o criador de ações como seguidor de ações quando uma nova ação é criada';
...
$lang['task_biillable_checked_on_creation'] = 'A opção faturável é marcada por padrão quando uma nova ação é criada?';
...
$lang['not_task_status_changed'] = '%s - status da ação alterado para %s';

$lang['not_project_activity_task_status_changed'] = 'Status da ação alterado';
...
$lang['lead_is_contact_create_task'] = 'Crie ações se o remetente do email já for cliente e atribua ao responsável.';
...
$lang['only_project_tasks'] = 'Apenas ações relacionadas ao projeto';
...
$lang['project_hide_tasks_settings_info'] = 'As ações são excluídas da tabela de ações principal deste projeto, você pode visualizar as ações do projeto somente nessa área.';
...
$lang['showing_billable_tasks_from_project'] = 'Mostrando ações faturáveis ​​do projeto';

$lang['no_billable_tasks_found'] = 'Ações faturáveis ​​não encontradas';
...
$lang['checklist_templates'] = 'Modelos de lista de ações';
...
$lang['calendar_only_assigned_tasks'] = 'Mostrar apenas as ações atribuídas ao membro da equipe conectado';
...
$lang['project_changing_status_recurring_tasks_notice'] = 'Você está alterando o status para {0}, todas as ações recorrentes serão canceladas';
...
$lang['no_reminders_for_this_task'] = 'Nenhum lembrete para esta ação';
...
$lang['customer_files_info_message'] = 'Arquivos de projetos e ações vinculados ao cliente não são mostrados nesta tabela.';
...
$lang['selecione_medico_encaminhamento'] = 'Selecione o Médico responsável pelo encaminhamento';

$lang['medico'] = 'Médico';

$lang['medicos'] = 'Médicos';

$lang['valor_unitario'] = 'Valor Unitário';

$lang['sem_medico'] = 'Sem Médico';

$lang['invoice_estimate_activity_updated_item_medico'] = 'médico do item atualizada de %s para %s';

$lang['quantidade'] = 'Quantidade';

$lang['historico'] = 'Histórico';

$lang['anotacoes'] = 'Anotações';

$lang['notes'] = 'Anotações';

$lang['new_historico'] = 'Novo Registro';

$lang['cliente_paciente'] = 'Cliente/ Paciente';

$lang['convenio'] = 'Convênio';

$lang['ativo'] = 'Ativo';

$lang['palavras_chaves'] = 'Palavras Chaves';

$lang['palavra_chave'] = 'Palavra Chave';

$lang['new_palavra'] = 'Nova Palavra';

$lang['palavra_deletada'] = 'Palavra Deletada';

$lang['propostas'] = 'Propostas';

$lang['procedimento'] = 'Procedimento';

$lang['valor_procedimento'] = 'Valor Procedimento';

$lang['quantidade'] = 'Quantidade';

$lang['data_faturamento'] = 'Dt Fatutamento';

$lang['valor_pago'] = 'Valor recebido';

$lang['new_medico'] = 'Novo Médico';

$lang['import_medico'] = 'Importar Médicos';

$lang['cns_medico'] = 'CNS';

$lang['crm_medico'] = 'CRM';

$lang['celular_medico'] = 'Contato';

$lang['email_medico'] = 'E-mail';

$lang['cpf_medico'] = 'CPF';

$lang['repasse_medico'] = 'Repasse';

$lang['medico_lowercase'] = 'Médico';

$lang['celular'] = 'Celular';

$lang['medico_add_edit_profile'] = 'Cadastro';

$lang['medico_procedimento_profile'] = 'Procedimentos';

$lang['valor_repasse'] = 'Valor Repasse';

$lang['repasse_medico'] = 'Repasse Médico';

$lang['valor_procedimento'] = 'Valor Procedimento';

$lang['procedimento_repasse_medico'] = 'Procedimentos / Repasse';

$lang['new_repasse_medico'] = 'Novo Repasse';

$lang['tipo_repasse_medico'] = 'Tipo Repasse';

$lang['update_valor'] = 'Atualizar Valor';

$lang['repasse_updated_successfully'] = 'Repasse atualizado com sucesso';

$lang['relatorio_faturamento'] = 'Relatório de Faturamento';

$lang['selecione_centro_custo'] = 'Selecione o Centro de Custo';

$lang['nome_nota_fiscal'] = 'Nome para Nota Fiscal';

$lang['cpf_nota_fiscal'] = 'CPF para Nota Fiscal';

$lang['agenda'] = 'Agenda';

$lang['queixas_hda'] = 'QUEIXAS E HDA';

$lang['antecedentes'] = 'ANTECEDENTES FAMILIARES E PESSOAIS';

$lang['refracao'] = 'REFRAÇÃO';

$lang['Biomicroscopia'] = 'BIOMICROSCOPIA';

$lang['fundoscopia'] = 'FUNDOSCOPIA';

$lang['diagnostico'] = 'DIAGNÓSTICO';

$lang['conduta'] = 'CONDUTA';

$lang['informacoes_adicionais'] = 'INFORMAÇÕES ADICIONAIS';

$lang['agenda'] = 'AGENDA';

$lang['tipo_consulta'] = 'Tipo de Agendamento';

$lang['tipo_paciente'] = 'Pacientes';

$lang['lista_paciente'] = 'Lista Pacientes';

$lang['producao_aba'] = 'Visualizar ABA de Produção';

$lang['desconto_aba'] = 'Visualizar ABA de Desconto';

$lang['editar_campo_qty'] = 'Editar o campo quantidade do procedimento';

$lang['editar_campo_valor'] = 'Editar o campo valor do procedimento';

$lang['editar_campo_desconto'] = 'Editar o campo de valor do desconto';

$lang['editar_campo_destino_desconto'] = 'Editar o campo de destino do desconto';

$lang['vendas'] = 'Vendas';

$lang['producao'] = 'Produção';

$lang['tesouraria'] = 'Tesouraria';

$lang['faturamento'] = 'Faturamento';

$lang['atualizacao_repasse_medico'] = 'Atualização do repasse médico';

$lang['desconto'] = 'Desconto';

$lang['numero_carteirinha'] = 'Número Carteirinha';

$lang['uso_medicacoes'] = 'USO DE MEDICAÇÕES';

$lang['alergias'] = 'ALERGIAS';

$lang['habitos_sociais'] = 'HÁBITOS SOCIAIS';

$lang['exames_fisicos'] = 'EXAMES FÍSICOS';

$lang['data_execucao'] = 'Data Realização';

$lang['tesouraria'] = 'Tesouraria';

$lang['tesouraria_caixa'] = 'Tesouraria (Caixa)';

$lang['caixa'] = 'Caixa';

$lang['caixas'] = 'Caixas';

$lang['new_caixa'] = 'Novo Caixa';

$lang['open_caixa'] = 'Abrir Caixa';

$lang['close_caixa'] = 'Fechar Caixa';

$lang['close_all_caixa'] = 'Fechar todos Caixa(s)';

$lang['acesso_medico'] = 'Acesso Médico';

$lang['anamnese'] = 'Anamnese';

$lang['entrada_caixa'] = 'Entrada de Caixa';

$lang['valor_transferencia'] = 'Valor de Transferência';

$lang['repasses'] = 'Repasses';

$lang['repasse'] = 'Repasse';

$lang['valor_repasse'] = 'Valor Repasse';

$lang['observacao'] = 'Observação';

$lang['invoice_access_fatura'] = 'Acessou a fatura depois de criada';

$lang['click_invoice_update_fatura'] = 'Clicou em editar fatura depois de criada';

$lang['conta_financeira'] = 'Conta Financeira';

$lang['evolucao'] = 'Evolução';

$lang['solicitacao_exames'] = 'Solicitação de Exames';

$lang['codigo_tuss'] = 'Código Tuss';

$lang['usuario_sinconecta'] = 'Usuário Sinconecta';

$lang['tabela_preco'] = 'Tabela de Preço';

$lang['tabela_preco_repasse'] = 'Tabela de Repasse';

// FINANCEIRO

$lang['plano_contas'] = 'Plano de Contas';

$lang['categoria'] = 'Categoria';

$lang['categorias'] = 'Categorias';

$lang['tipo_centro_custo'] = 'Tipo de Centro de Custo';

$lang['centro_custo'] = 'Centro de Custo';
 ...
 * 06/10/2022
 * @WannaLuiza
 * PLANO DE AÇÃOhome_my_projects
 */
$lang['action_plans'] = 'Planos de ação';
$lang['new_action_plan'] = 'Novo Plano de ação';
$lang['action_plan_summary'] = 'Resumo de planos de ação';
$lang['home_my_plans'] = 'Meus Planos';
$lang['responsible_plan'] = 'Responsável';
$lang['sector_plan'] = 'Setor';
$lang['plan_settings'] = 'Configurações do Plano';

#Registro de ocorrencia

$lang['ro_status_changed_successfully'] = 'Alterar o Status do Registro';
$lang['ro_status_changed_fail'] = 'Problema para Alterar o Status do Registro';

$lang['ro_status_db_2'] = 'Em Progresso';
$lang['ro_status_db_1'] = 'Aberto';
$lang['ro_status_db_3'] = 'Respondido';
$lang['ro_status_db_4'] = 'Em Espera';
$lang['ro_status_db_5'] = 'Fechado';
$lang['ro_status_db_6'] = 'Cancelado';

#NOTIFICATIONS INTRANET

$lang['intra_not_teste_wanna'] = 'Nova Solicitação';



#REGISTRO DE OCORRÊNCIA NOTIFICAÇÕES ASSUNTOS
$lang['ro_received_subject'] = 'Registro de Ocorrência Recebido (Setor_responsável)';
