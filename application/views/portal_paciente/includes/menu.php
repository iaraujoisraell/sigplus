...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main" translate="no">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?php echo base_url(); ?>portal/Dashboard_portal_paciente/portal_paciente">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item mb-2 mt-0">
                <a data-bs-toggle="collapse" href="#ProfileNav" class="nav-link text-white" aria-controls="ProfileNav" role="button" aria-expanded="false">
                    ...
                    <span class="nav-link-text ms-2 ps-1"><?php
                                                            $nome_array = explode(' ', $info_perfil->nome_completo);
                ...
                <div class="collapse" id="ProfileNav" style="">
                    <ul class="nav ">
                        ...
                        <?php } ?>
                        <li class="nav-item">
                            <a class="nav-link text-white " href="<?php echo base_url(); ?>portal/signin_paciente/finish">
                                <span class="sidenav-mini-icon"> S </span>
            ...
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>portal/Dashboard_portal_paciente/portal_paciente" class="nav-link text-white active">
             ...
             <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>portal_paciente/workflow">
