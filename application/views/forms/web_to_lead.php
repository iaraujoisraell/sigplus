...
<body style="font-size: 18px; padding: 20px 20px 20px 20px; background-color: #ffffff; border-style: solid; border-width: 40px 40px 40px 40px; border-color: #f5f8fb; border-radius: 10px 10px 10px 10px;" class="web-to-lead <?php echo $form->form_key; ?>"<?php if(is_rtl(true)){ echo ' dir="rtl"';} ?>>
      ...
      <div class="<?php if($this->input->get('col')){echo $this->input->get('col');} else {echo 'col-md-12';} ?>">
        ...
        <?php } ?>
         ...
         <div class="text-left col-md-12 submit-btn-wrapper">
          <button  style="padding: 12px 20px 12px 20px; border-radius: 20px 20px 20px 20px; font-size: 16px; background-color: #20b3e7;" class="btn btn-success" id="form_submit" type="submit"><?php echo $form->submit_btn_name; ?></button>
        </div>
      </div>
