        ...
        ?>">
            <div class="panel_s" >
                ...
                if ($documento->publicado != true and $current == true) {
                    ...
                    if ($last == true) {
                        echo form_open(base_url('gestao_corporativa/cdc/publicar?id=' . $documento->id), array('id' => 'form_cdc'));
                    } else {
                        echo form_open(base_url('gestao_corporativa/cdc/prosseguir_retroceder/' . $documento->id), array('id' => 'form_cdc'));
                    }
                    ?>
                                ...
                                <?php } else { ?>
                                    <div class="col-md-6">
                                        ...
                                        <?php // REPROVAR echo form_open(base_url('gestao_corporativa/cdc/prosseguir_retroceder?id=' . $documento->id . '&action=' . true));   ?>
                                           ...
                                           <textarea id="timesheet_note" name="msg" 
                                           class="form-control" 
                                           rows="4"></textarea></div><button  type="submit" class="btn btn-info btn-xs">Salvar</button>'
                                    ...
                                    <div class="alert alert-warning alert-dismissible">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="file" data-name_value="<?php echo $documento->id; ?>-CDC-<?php echo $documento->codigo; ?>__" class="form-control" name="file" id="file" data-target="assets/intranet/arquivos/cdc_arquivos/cdc/" accept=".pdf, .PDF">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-success  p8-half"  type="submit">ENVIAR <i class="fa fa-paper-plane"></i></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
