<div class="modal fade" id="view_terceiros" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <input type="hidden" id="terceiro_id" value="<?php echo $id; ?>" />
...
<script>
    $(function () {
        var Params = {};
        Params['terceiro_id'] = '[id="terceiro_id"]';
