                    ...
                    <div class="row" style="padding: 5px;">
                        <div class="col-md-12">
                            <div class="callout callout-info">
                                <h5><strong>Objetivo:</strong> <a id="pencil" type="button" onclick="delClass('objetivo', 'hide'); addClass('pencil', 'hide'); delClass('closee', 'hide'); addClass('esconder', 'hide');" class="btn"><i class="fa fa-pencil-square-o"></i></a>
                                ...
                                <h5><strong>Resposabilidade:</strong> <?php echo $processo->fluxo_nome; ?></h5>
                                <h5><strong>Categoria:</strong> <?php echo $documento->nome_categoria; ?></h5><!-- comment -->
                                <h5><strong>Data de cadastro:</strong> <?php
                            ...
                            if ($total) {
                                foreach ($total as $um) {
                                    if ($um['status'] == 1) {
                                        ?>
                                        <blockquote class="quote-success col-md-12">
                                            <p><?php echo $um['fluxo_nome']; ?>(<?php echo $um['firstname'] . ' ' . $um['lastname']; ?>): AVALIADO </p>
                                        </blockquote>
                                        <?php
                                    } else {
                                        ?>
                                        <blockquote class="quote-danger col-md-12">
                                            <p><?php echo $um['fluxo_nome']; ?>(<?php echo $um['firstname'] . ' ' . $um['lastname']; ?>): AGUARDANDO AVALIAÇÃO <?php if ($processo->id == $um['id']) { ?>
                            ...
                            <div class="col-md-12">
                                <div class="progress progress-sm active">
                                    <div class="progress-bar bg-success progress-bar-striped" role="progressbar" aria-valuenow="<?php echo $resultado; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $resultado; ?>%;">
                                        <span class="sr-only"><?php echo $resultado; ?>% Complete</span>
                                    </div>
                                </div>
                                <p class="col-md-12"><code><?php echo intval($resultado); ?>% do fluxo de aprovação concluído!</code></p>
                            </div>
            ...
            <td colspan="5">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                            ...
                            <a class="btn bg-blue w-100 " onclick="delClass('destinatarios', 'hide');"  > VISUALIZAR DESTINATÁRIOS <i class="fa fa-users"></i></a>
                            <div class="col-md-12 hide" id="destinatarios">
                                ...
                                <div class="col-md-12 mb-4 mt-2">
                                    ...
                                    <button class="btn btn-sm bg-blue float-right" type="submit">Salvar</button> 
                                </div>
                                <?php echo form_close(); ?>
                                ...
                                <div class="app-card app-card-doc shadow-sm h-100">
                                    ...
                                    <div class="app-card-body p-3 has-card-actions">
                                        ...
                                        <?php if ($emissor->id == $processo->id and $emissor->staff_id == get_staff_user_id()) { ?>
                                            <a class="btn bg-yellow w-100" target="_blank" href="<?php echo base_url(); ?>gestao_corporativa/intra/documentos/editar_all/<?php echo $documento->id; ?>"  > EDITAR <delClass('editar', 'hide');i class="fa fa-exclamation-triangle"></i></a>
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                <?php if ($log['sim_nao'] == 3) { ?>
                                                    <span class="time"><i class="fas fa-calendar"></i> <?php echo date(' d/m/Y H:i:s A', strtotime($log['date_created'])); ?></span>
                                                    <h3 class="timeline-header"><?php echo $log['firstname'] . $log['lastname']; ?></h3>
