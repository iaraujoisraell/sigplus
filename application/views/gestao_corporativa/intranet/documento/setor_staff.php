...
//$selected = ( array_key_exists($v['staffid'],$staffs) ? "selected" : "" );
    //echo $v['staffid']; echo '<br>'; print_r($staffs);
    if($staffs){
...
//?>
<option <?php echo $selected; ?> value="<?php echo ($v['staffid'].'-'. $v['staffdepartmentid']); ?>" data-section="<?php echo $v['name']; ?>" data-description="<?php echo $v['name']; ?>"><?php echo $v['firstname'].' '.$v['lastname']; ?></option>
<?php
} //}
?>
</select>
