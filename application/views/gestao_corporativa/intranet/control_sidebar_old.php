            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item ">
                            <a title="<?php echo _l('nav_todo_items'); ?>" href="<?php echo base_url('admin/todo'); ?>" class="nav-link ">
                                <i class="far fa-check-square"></i>
                                <p>
                                    Minhas Atividades
                                    <span class="right badge badge-danger"><?php echo $current_user->total_unfinished_todos; ?></span>
                                </p>
