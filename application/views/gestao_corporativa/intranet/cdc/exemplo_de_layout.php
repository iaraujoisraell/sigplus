                ...
                <div class="panel-body">
                    <?php if (is_array($css)) { ?>
                        <?php if (count($css) > 0) { ?>
                            ...
                            <div class="modal-dialog modal-lg" id="modal-xal">
                                                ...
                                                <tbody >
                                                    ...
                                                    foreach ($css as $ciente) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td ><?php echo $ciente['dt_ciente']; ?></td>
                                                            <td > <?php if ($ciente['status'] != 1) { ?> <a type="button" class="btn btn-flat" href="<?php echo base_url('gestao_corporativa/intra/comunicado/delete_send?ids=' . $ciente['id'] . '.' . $ciente['ci_id']); ?>" ><i class="fa fa-trash " ></i></a> <?php } ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
                    ...
                    <div class="modal-dialog modal-lg" id="modal-destinatarios">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
