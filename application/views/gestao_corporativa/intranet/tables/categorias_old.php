...
foreach ($rResult as $aRow) {
    ...
    if ($rel_type == 'workflow') {
        $row[] = '<a class="btn btn-default btn-icon" data-toggle="tooltip" ' . $disabled . ' ' . $msg . ' target="blanck" href="' . $caminho . '" ><i class="fa fa-list"></i> Visualizar</a>';
    }
    if ($rel_type == 'api') {
    ...
    if ($rel_type != 'api') {
        if ($rel_type != 'autosservico') {
            $row[] = '<a class="btn btn-default btn-icon" data-toggle="tooltip" ' . $msg . ' ' . $caminho . ' ' . $disabled . '><i class="fa fa-list"></i> Visualizar</a>';
        }
    } else {
