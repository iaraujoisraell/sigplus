...
$aColumns = array_merge($aColumns, [
    db_prefix() . '_intranet_workflow_cancel.cancellation as date',
    db_prefix() . '_intranet_workflow_cancel.dt_created as dt_created',
    db_prefix() . '_intranet_workflow_cancel.user_create as user_created',
    db_prefix() . '_intranet_workflow_cancel.active as active'
        ]);
$sIndexColumn = 'id';
$sTable = db_prefix() . '_intranet_workflow_cancel';
...
array_push($where, 'AND ' . db_prefix() . '_intranet_workflow_cancel.deleted = 0');
array_push($where, ' AND ' . db_prefix() . '_intranet_workflow_cancel.empresa_id = ' . $empresa_id);
