                ...
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        ...
                        if ($profile_image) {
                            ...
                            <img class="img-circle" style="min-width: 100px; min-height: 100px; max-height: 100px; max-width: 100px;"  src="<?php echo base_url(); ?>uploads/staff_profile_images/<?php echo $usuario_id . '/small_' . $profile_image; ?>" alt="User Avatar">
                        <?php } else { ?>
