<div class="card ">
    ...
    <div class="card-body " style="margin-left: auto; margin-right: auto; padding-top: 3px; padding-bottom: 3px;" >
        ...
        <?php if (has_permission_intranet('modules', '', 'view_ros') || is_admin()) { ?>
            <a style="height: 90px; width: 110px;  background-color: #ffffff;" href="<?php echo base_url('gestao_corporativa/Registro_ocorrencia'); ?>" class="btn btn-app ">
        ...
        <?php if (has_permission_intranet('modules', '', 'view_ras') || is_admin()) { ?>
            <a style="height: 90px; width: 110px;  background-color: #ffffff; " href="<?php echo base_url('gestao_corporativa/atendimento_Controle/index'); ?>" class="btn btn-app">
                <span class="badge bg-danger"></span>
