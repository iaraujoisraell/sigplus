        ...
        <div class="col-md-12">
            ...
            <div class="card card-widget widget-user">
                ...
                <div class="widget-user-header text-white"
                    style="background: url('<?php echo $url_bg; ?>'); background-size: 100%; center: center;">
                    ...
                    <div class="avatar-upload" style="position: absolute; left: 100px;">
                        <div class="avatar-edit">
                            ...
                            <label for="background"><img style="margin: 6px; width: 20px; height: 20px;"
                                    src="<?php echo base_url() ?>assets/lte/novosicones/edit.png"></label>
                        </div>
                    ...
                    <div class="avatar-upload">
                        ...
                        <div class="avatar-edit">
                            ...
                            <label for="imageUpload">
                                <img style="margin: 6px; width: 20px; height: 20px;"
                                    src="<?php echo base_url() ?>assets/lte/novosicones/pencil.png">
                            </label>
                        </div>
                        ...
                        <div class="avatar-preview">
                            <?php if ($staff->profile_image): ?>
                                <div id="imagePreview"
                                    style="background-image: url('<?php echo base_url(); ?>uploads/staff_profile_images/<?php echo $staff->staffid; ?>/small_<?php echo $staff->profile_image; ?>');">
                                </div>
                            <?php else: ?>
                                <div id="imagePreview"
                                    style="background-image: url('<?php echo base_url(); ?>assets/images/user-placeholder.jpg');">
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($staff->facebook) { ?>
                            <a target="_blank" style="margin-right: 10px; "
                                href="<?php echo 'https://www.facebook.com/' . ($staff->facebook); ?>">
                                <img alt="Qries" src="<?php echo base_url() ?>assets/lte/novosicones/logo-facebook.svg"
                                    width="25px" height="25px">
                            </a>
                        <?php } ?>
                        <?php if ($staff->instagram) { ?>
                            <a target="_blank" style="margin-right: 10px; "
                                href="<?php echo 'https://www.instagram.com/' . ($staff->instagram); ?>">
                                <img alt="Qries" src="<?php echo base_url() ?>assets/lte/novosicones/logo-instagram.svg"
                                    width=25px" height="25px">
                            </a>
                        <?php } ?>
                        <?php if ($staff->linkedin) { ?>
                            <a target="_blank" style="margin-right: 10px; "
                                href="<?php echo 'https://www.linkedin.com/in/' . ($staff->linkedin); ?>">
                                <img alt="Qries" src="<?php echo base_url() ?>assets/lte/novosicones/logo-linkedin.svg"
                                    width=25px" height="25px">
                            </a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                    ...
                                    <div>
                                        ...
                                        for ($i = 0; $i < count($notifications); $i++) {
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-footer">
                                                    <a href="<?php echo $notifications[$i]['link']; ?>" target="_blanck"
                                    ...
                                    <div class="row">
                                        <?php if (is_file('assets/intranet/assinatura_support/ass_nova/' . $staff->user . '.jpg')) { ?>
                                            <div class="col-md-12" style="text-align: center; margin-bottom: 10px;" id="resposta">
                                                ...
                                                <?php  $timestamp = time();?>
                                                    <img alt="Assinatura" style="max-width: 30%;" 
                                                        src="<?php echo base_url('assets/intranet/assinatura_support/ass_nova/' . $staff->user . '.jpg'); ?>?version=<?php echo rand(0, 99999);?>"><br />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required="true" type="text" class="form-control" id="matricula"
                                                    name="matricula" placeholder="Matrícula" readonly
                                                    value="<?php echo $staff->user; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nome" class="col-form-label">Nome</label>
                                                <input required="true" type="text" class="form-control" id="nome"
                                                    name="nome" placeholder="Ex: Nome Sobrenome" readonly
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required="true" type="text" class="form-control" id="cargo"
                                                    name="cargo" placeholder="Ex: Cargo" readonly
                                                    value="<?php if($info['CARGO']){ echo $info['CARGO']; } else {  echo $staff->cargo; } ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="setor" class="col-form-label">Setor</label>
                                                <input required="true" type="text" class="form-control" id="setor"
                                                    name="setor" placeholder="Ex: Setor" readonly
                                                    value="<?php echo $info['SETOR'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email" class="col-form-label">E-mail do Funcionário</label>
                                                <input required="true" type="text" class="form-control" id="email_"
                                                    name="email_" placeholder="Ex: exemplo@exemplo.exemplo"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="telefone" class="col-form-label">Telefone do
                                                    Funcionário</label>
                                                <input required="true" type="text" class="form-control" id="telefone"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required="true" type="text" class="form-control" id="site"
                                                    name="site" placeholder="www.unimedmanaus.com.br"
                                                    value="www.unimedmanaus.com.br">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <?php if (!is_file('assets/intranet/assinatura_support/ass_nova/' . $staff->user . '.jpg')) { ?>
                            ...
                            ?>" id="settings">
                                ...
                                <input type="hidden" class="form-control" id="inputEmail" name="staffid"
                                    placeholder="Formação acadêmica" value="<?php echo $staff->staffid; ?>">
                                <form class="form-horizontal">
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 col-form-label">Nome</label>
                                        <div class="col-sm-10">
                                            <input required="true" type="text" class="form-control" id="inputName"
                                                name="nome_staff" placeholder="Nome"
                                                value="<?php echo $staff->firstname ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required="true" type="text" class="form-control" id="inputName"
                                                name="sobrenome_staff" placeholder="Sobrenome"
                                                value="<?php echo $staff->lastname ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail" class="col-sm-2 col-form-label">Formação
                                            acadêmica</label>
                                        <div class="col-sm-10">
                                            <input required="true" type="text" class="form-control" id="inputEmail"
                                                name="formacao_acad" placeholder="Formação acadêmica"
                                                value="<?php echo $staff->formacao_academica; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nome_empresa"
                                                placeholder="Empresa" value="<?php echo $staff->empresa; ?>" disabled=""
                                                style="color: grey;">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required="true" type="date" class="form-control" id="inputSkills"
                                                name="aniversario" placeholder="Aniversário"
                                                value="<?php echo $staff->data_nascimento; ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" id="inputSkills" name="descricao"
                                                placeholder="Sobre mim"><?php echo $staff->descricao; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" onclick="check_pessoal(this.checked)"
                                                class="custom-control-input" id="customSwitch1">
                                            <label class="custom-control-label" for="customSwitch1"></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <input required="true" type="text" class="form-control" id="phonenumber"
                                                name="num_pessoal" placeholder="Número pessoal"
                                                value="<?php echo $staff->phonenumber; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" onclick="check_comercial(this.checked)"
                                                class="custom-control-input" id="customSwitch2">
                                            <label class="custom-control-label" for="customSwitch2"></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <input required="true" type="text" class="form-control" id="num_comercial"
                                                name="num_comercial" placeholder="Número comercial"
                                                value="<?php echo $staff->num_comercial; ?>"
                                                onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="contatos" class="col-sm-2 col-form-label"></label>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" onclick="check_ramal(this.checked)"
                                                class="custom-control-input" id="customSwitch3">
                                            <label class="custom-control-label" for="customSwitch3"></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <input required="true" type="number" class="form-control" id="num_ramal"
                                                name="num_ramal" placeholder="Número do ramal"
                                                value="<?php echo $staff->num_ramal; ?>"" />
                                        </div>
                                    ...
                                    <div class=" form-group row ">
                                        <label for=" inputSkills" class="col-sm-2 col-form-label"></label>
                                            <div>
                                                <img style="margin: 6px; width: 25px; height: 25px;"
                                                    src="<?php echo base_url() ?>assets/lte/novosicones/logo-facebook.svg">
                                            </div>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputSkills" name="facebook"
                                                    placeholder="Facebook" value="<?php echo $staff->facebook; ?>">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div>
                                                <img style="margin: 6px; width: 25px; height: 25px;"
                                                    src="<?php echo base_url() ?>assets/lte/novosicones/logo-instagram.svg">
                                            </div>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div>
                                                <img style="margin: 6px; width: 25px; height: 25px;"
                                                    src="<?php echo base_url() ?>assets/lte/novosicones/logo-linkedin.svg">
                                            </div>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputSkills" name="linkedin"
                                                    placeholder="Linkedin" value="<?php echo $staff->linkedin; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div>
                                                <img style="margin: 6px; width: 25px; height: 25px;"
                                                    src="<?php echo base_url() ?>assets/lte/novosicones/logo-email.svg">
                                            </div>
                                            <div class="col-sm-8">
                                                <input type="email" class="form-control" id="inputSkills" name="email"
                                                    placeholder="E-mail" value="<?php echo $staff->email; ?>" disabled>
                                            </div>
                                        </div>
                                        <br>
