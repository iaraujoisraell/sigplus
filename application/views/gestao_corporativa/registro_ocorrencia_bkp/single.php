                        ...
                        <?php if ($setor_responsavel == true) { ?>
                            <div class="col-md-3 text-right">
                                <div class="row">
                                    ...
                                    <?php } else { ?>
                                        <a class="btn btn-success w-100" data-toggle="tooltip" href="<?php echo base_url("gestao_corporativa/registro_ocorrencia/assumir_registro/$ro->id"); ?>"><i class="fa fa-hand-pointer-o"></i> ASSUMIR REGISTRO <i class="fa fa-hand-pointer-o"></i></a>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
...
<script>
    ...
    function limitar(id, limitado) {
        $.ajax({
            ...
            data: {
                limitado: limitado, id: id, ro_id: '<?php echo $ro->id; ?>'
            },
            success: function (data) {
                if (limitado == 1) {
    ...
    function edit_prazo(id, prazo) {
        $.ajax({
            ...
            url: "<?php echo base_url('gestao_corporativa/Registro_ocorrencia/edit_info_atuante'); ?>",
            data: {
                prazo: prazo, id: id, ro_id: '<?php echo $ro->id; ?>'
            },
            success: function (data) {
    ...
    function edit_department(id, dep) {
        $.ajax({
            ...
            url: "<?php echo base_url('gestao_corporativa/Registro_ocorrencia/edit_info_atuante'); ?>",
            data: {
                department_id: dep, id: id, ro_id: '<?php echo $ro->id; ?>'
            },
            success: function (data) {
    ...
    function finalizar_atuante(id) {
        $.ajax({
            ...
            url: "<?php echo base_url('gestao_corporativa/Registro_ocorrencia/edit_info_atuante'); ?>",
            data: {
                date_finalizado: '<?php echo date('Y-m-d'); ?>', id: id, ro_id: '<?php echo $ro->id; ?>'
            },
            success: function (data) {
