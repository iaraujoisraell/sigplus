...
<div class="content">
    <div class="row">
        <div class="col-md-12">
            <h5 style="font-weight: bold;">INTRANET - WORKFLOW POR SETORES</h5>
            <div>
      ...
      <div class="row">
        ...
        render_datatable($table_data, 'workflow_setores');
        ?>
...
$(function(){
  ...
  var CustomersServerParams = {};
   ...
   var tAPI = initDataTable('.table-workflow_setores', '<?php echo base_url(); ?>' + 'gestao_corporativa/workflow/table_wf_setores', [0], [0], CustomersServerParams, <?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1, 'desc'))); ?>);

     //var tAPI = initDataTable('.table-workflow_setores', admin_url+'workflow/table_wf_setores', [0], [0], CustomersServerParams, [1, 'desc']);
 ...
 function procedimentos_table_reload() {
   ...
   if ($.fn.DataTable.isDataTable('.table-workflow_setores')) {
     $('.table-workflow_setores').DataTable().destroy();
   }
   var tAPI = initDataTable('.table-workflow_setores', '<?php echo base_url(); ?>' + 'gestao_corporativa/workflow/table_wf_setores', [0], [0], CustomersServerParams, <?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1, 'desc'))); ?>);
