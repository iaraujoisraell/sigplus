                  ...
                  if((isset($is_admin) && $is_admin) ||
                   ...
                   (
                      ...
                      &&
                        ...
                        ||
                        (isset($role)
                         && has_role_permission($role->id, ($capability == 'view' ? 'view_own' : 'view'), $feature))
                      )
                   )
                  ){
                   $disabled = ' disabled ';
                  } else if((isset($member) && staff_can_intranet($capability, $feature, $member->staffid))
                    || isset($role) && has_role_permission_intranet($role->id, $capability, $feature)){
                  $checked = ' checked ';
                  }
                  ?>
               <div class="checkbox">
