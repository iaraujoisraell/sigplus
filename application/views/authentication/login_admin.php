 ...
 <div class="container">
  <div class="row">
   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper">
       <h3><font style="color: #ffffff"><?php echo 'Olá <b>'.$user->firstname.' '.$user->lastname.'</b>, seja bem vindo!!!'; ?></font></h3>
    <div class="mtop40 authentication-form">
        <div class="company-logo">
      <?php get_company_logo($user->empresa_id); ?>
    </div>
      ...
      <div class="form-group">
        ...
        <input type="email" id="email" readonly="true" name="email" value="<?php echo $user->email; ?>" class="form-control" autofocus="1">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <a href="<?php echo admin_url('authentication/logout'); ?>" class="btn btn-warning btn-block" ><?php echo 'Cancelar'; ?></a>
      </div>
        <div class="form-group">
