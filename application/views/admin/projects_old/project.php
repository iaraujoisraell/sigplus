                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group select-placeholder">
                                ...
                                <select name="categoria_id" id="categoria_id" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <option value="" selected disabled>Selecione</option>
                                    <?php foreach ($categorias as $categoria) { ?>
                                    
                                    <option value="<?php echo $categoria['id']; ?>" <?php if (isset($project) && $project->categoria_id == $categoria['id']) { echo 'selected'; } ?>>
                    ...
                    <div class="form-group">
                        <div class="checkbox checkbox-success">
                            ...
                            if ((isset($project) && $project->progress_from_tasks == 1) || !isset($project)) {
                                echo 'checked';
                            }
                        ...
                        <div class="col-md-6">
                            <div class="form-group select-placeholder">
                                ...
                                <select name="billing_type" class="selectpicker" id="billing_type" data-width="100%" <?php echo $disable_type_edit; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <option value=""></option>
                                    <option value="1" <?php
                                    if (isset($project) && $project->billing_type == 1 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 1) {
                                        echo 'selected';
                                    }
                                    ?>><?php echo _l('project_billing_type_fixed_cost'); ?></option>
                                    <option value="2" <?php
                                    if (isset($project) && $project->billing_type == 2 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 2) {
                                        echo 'selected';
                                    }
                                    ?>><?php echo _l('project_billing_type_project_hours'); ?></option>
                                    <option value="3" data-subtext="<?php echo _l('project_billing_type_project_task_hours_hourly_rate'); ?>" <?php
                                    if (isset($project) && $project->billing_type == 3 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 3) {
                                        echo 'selected';
                                    }
                            ...
                            <div class="form-group select-placeholder">
                                ...
                                <select name="status" id="status" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <?php foreach ($statuses as $status) { ?>
                                        ...
                                        if (!isset($project) && $status['id'] == 2 || (isset($project) && $project->status == $status['id'])) {
                                            echo 'selected';
                                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            if (isset($project)) {
                                if($project->analista){
                                   array_push($selected, $project->analista);
                                }
                            } else {
                                array_push($selected, get_staff_user_id());
                            }                            
                            echo render_select('analista', $staff, array('staffid', array('firstname', 'lastname')), 'Analista', $selected);
                            ?>
                        </div>
                        <div class="col-md-6">
                            <?php
                            if (isset($project)) {
                                if($project->gerente){
                                   array_push($selected, $project->gerente);
                                }
                            } else {
                                array_push($selected, get_staff_user_id());
                            }      
                            echo render_select('gerente', $staff, array('staffid', array('firstname', 'lastname')), 'Gerente', $selected);
                            ?>
                        </div>
                    </div>
                    ...
                    $contents = '';
                    if (isset($project)) {
                        $contents = $project->objetivo;
                    }
                    ?>
                    <?php echo render_textarea('objetivo', '', $contents, array(), array(), '', 'tinymce'); ?>
                    ...
                    $contents = '';
                    if (isset($project)) {
                        $contents = $project->justificativa;
                    }
                    ?>
                    <?php echo render_textarea('justificativa', '', $contents, array(), array(), '', 'tinymce'); ?>
                    <p class="bold">Benefícios</p>
                    <?php
                    $contents = '';
                    if (isset($project)) {
                        $contents = $project->beneficios;
                    }
                    ?>
                    <?php echo render_textarea('beneficios', '', $contents, array(), array(), '', 'tinymce'); ?>
                    <p class="bold">Restrições</p>
                    <?php
                    $contents = '';
                    if (isset($project)) {
                        $contents = $project->restricoes;
                    }
                    ?>
                    <?php echo render_textarea('restricoes', '', $contents, array(), array(), '', 'tinymce'); ?>
                    <p class="bold">Premissas</p>
                    <?php
                    $contents = '';
                    if (isset($project)) {
                        $contents = $project->premissas;
                    }
                    ?>
                    <?php echo render_textarea('premissas', '', $contents, array(), array(), '', 'tinymce'); ?>
                        ...
                        <?php } else { ?>
                            <div class="form-group mtop15 select-placeholder project-available-features">
                                ...
                                <select name="settings[<?php echo $setting; ?>][]" id="<?php echo $setting; ?>" multiple="true" class="selectpicker" id="available_features" data-width="100%" data-actions-box="true" data-hide-disabled="true">
                                    <?php
                                    foreach (get_project_tabs_admin() as $tab) {
                                        $selected = '';
                                        if (isset($tab['collapse'])) {
                                            ...
                                            <optgroup label="<?php echo $tab['name']; ?>">
                                                ...
                                                foreach ($tab['children'] as $tab_dropdown) {
                                                    $selected = '';
                                                    if (isset($project) && (
                                                            (isset($project->settings->available_features[$tab_dropdown['slug']]) && $project->settings->available_features[$tab_dropdown['slug']] == 1) || !isset($project->settings->available_features[$tab_dropdown['slug']]))) {
                                                        $selected = ' selected';
                                                        ...
                                                        foreach ($last_project_settings as $last_project_setting) {
                                                            if ($last_project_setting['name'] == $setting) {
                                                                if (isset($last_project_setting['value'][$tab_dropdown['slug']]) && $last_project_setting['value'][$tab_dropdown['slug']] == 1) {
                                                                    $selected = ' selected';
                                                                }
                                                            }
                                                        }
                                            ...
                                            if (isset($project) && (
                                                    (isset($project->settings->available_features[$tab['slug']]) && $project->settings->available_features[$tab['slug']] == 1) || !isset($project->settings->available_features[$tab['slug']]))) {
                                                $selected = ' selected';
                                            } else if (!isset($project) && count($last_project_settings) > 0) {
                                                foreach ($last_project_settings as $last_project_setting) {
                                                    if ($last_project_setting['name'] == $setting) {
                                                        if (isset($last_project_setting['value'][$tab['slug']]) && $last_project_setting['value'][$tab['slug']] == 1) {
                                                            $selected = ' selected';
                                                        }
                                                    }
                                                }
                                            ...
                                            ?>
                                            <option value="<?php echo $tab['slug']; ?>"<?php
                                            if ($tab['slug'] == 'project_overview') {
