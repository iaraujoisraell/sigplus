...
<?php if(isset($client)){ ?>
<h4 class="customer-profile-group-heading"><?php echo 'ANAMNESES'; ?></h4>
<div class="col-md-12">
...
<div class="row">
 ...
 <div class="usernote hide">
    ...
    <?php echo render_textarea( 'queixas_hda', 'queixas_hda', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'antecedentes', 'antecedentes', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'refracao', 'refracao', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'biomicroscopia', 'Biomicroscopia', '',array( 'rows'=>5)); ?> 
    <?php echo render_textarea( 'fundoscopia', 'fundoscopia', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'diagnostico', 'diagnostico', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'conduta', 'conduta', '',array( 'rows'=>5)); ?>
    <?php echo render_textarea( 'informacoes_adicionais', 'informacoes_adicionais', '',array( 'rows'=>5)); ?>
