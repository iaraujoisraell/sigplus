        ...
        <div class="col-md-12">
            <div class="horizontal-scrollable-tabs">
                ...
                <div class="horizontal-tabs">
                    <ul class="nav nav-tabs profile-tabs row customer-profile-tabs nav-tabs-horizontal" role="tablist">
                        ...
                        <?php if ($_SESSION['intranet'] == false) { ?>
                        <?php
                        ...
                        if (total_rows(db_prefix() . 'customfields', array('fieldto' => 'customers', 'active' => 1)) > 0) {
                            ...
                            ?>
                            <li role="presentation" class="<?php
                            if ($this->input->get('tab') == 'custom_fields') {
                                echo 'active';
                            };
                            ?>">
            ...
            <div class="tab-content mtop15">
                ...
                ?>" id="contact_info">
                    <div class="row">
                        <?php if($_SESSION['intranet'] == false){?>
                        <div class="col-md-12 mtop15 <?php
                        if (isset($client) && (!is_empty_customer_company($client->userid) && total_rows(db_prefix() . 'contacts', array('userid' => $client->userid, 'is_primary' => 1)) > 0)) {
                            echo '';
                        } else {
                            echo ' hide';
                        }
                        ?>" id="client-show-primary-contact-wrapper">
                            <div class="checkbox checkbox-info mbot20 no-mtop">
                                <input type="checkbox" name="show_primary_contact"<?php
                                if (isset($client) && $client->show_primary_contact == 1) {
                                    echo ' checked';
                                }
                    ...
                    <div class="col-md-6">
                        ...
                        <label>  CPF *</label>
                        <input type="text" maxlength="14" minlength="11" onkeypress="mascara_cpf(this);"  required="true"   title="Somente Números. 11 Caracteres"  name="vat" id="vat" placeholder="000.000.000-00 (somente números)" value="<?php echo $client->vat; ?>" class="form-control" >   
                        <br>
                        <?php
//}
...
//   echo render_input( 'vat', 'client_vat_number',$value);
                        ?>
                        <label> <font style="color: red">*</font> Dt Nascimento</label>
                        <input type="date" name="dt_nascimento" id="dt_nascimento"  value="<?php echo $client->dt_nascimento; ?>" class="form-control" >
                        <br>
                        <?php $value = ( isset($client) ? $client->numero_carteirinha : ''); ?>
                        <?php echo render_input('numero_carteirinha', 'numero_carteirinha', $value); ?>
                        <?php $value = ( isset($client) ? $client->phonenumber : ''); ?>

                        <label> <font style="color: red">*</font> Celular</label>
                        <input type="text" name="phonenumber" id="phonenumber" placeholder="(99) 9 9999-9999" onkeypress="mascara(this);" maxlength="15"  required="true" value="<?php echo $client->phonenumber; ?>" class="form-control">
                        <br>
                        <?php
                        if ((isset($client) && empty($client->email2)) || !isset($client)) {
                            $value = ( isset($client) ? $client->email2 : '');
                            echo render_input('email2', 'client_email', $value);
                        } else {
                            ?>
                            <?php $value = ( isset($client) ? $client->email2 : ''); ?>
                            <?php echo render_input('email2', 'client_email', $value); ?>
                            <?php
                        }
                        if (!$atendimento == true) {
                            $selected = array();
        ...
        <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
            <div class="modal fade" id="customer_admins_assign" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <?php echo form_open(admin_url('clients/assign_admins/' . $client->userid), array('class' => 'client-form', 'autocomplete' => 'off')); ?>
...
<script>
    ...
    function verifica_cpf(value) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/clients/client_cpf_exists'); ?>",
            data: {
                vat: value,
            },
