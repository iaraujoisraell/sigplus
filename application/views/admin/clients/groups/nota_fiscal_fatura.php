...
echo form_open_multipart(admin_url('clients/upload_attachment_fatura/'.$cliente_id.'/'.$invoice_id),array('class'=>'dropzone','id'=>'client-attachments-upload')); ?>
            ...
            <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
                ...
                <tbody>
                    <?php
                     ...
                     $attachments = get_all_customer_attachments($cliente_id, $invoice_id);
