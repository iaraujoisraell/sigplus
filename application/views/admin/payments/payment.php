					...
					<div class="col-md-12 no-padding">
						<div class="panel_s">
							<?php echo form_open($this->uri->uri_string()); ?>
                                                    <input type="hidden" name="invoiceid" value="<?php echo $payment->invoiceid; ?>">
							<div class="panel-body">
								...
								<?php echo render_select('paymentmode',$payment_modes,array('id','name'),'payment_mode',$payment->paymentmode); ?>
                                                                <?php echo render_select('conta_id',$contas, array('id','nome'),'conta_financeira',$payment->conta_id); ?>
								...
								<?php echo render_input('transactionid','payment_transaction_id',$payment->transactionid); ?>
                                                                <?php echo render_input('numero_nf','nota_fiscal',$payment->numero_nf); ?> 
                                                                <?php echo render_input('numero_cartao','payment_numero_cartao',$payment->numero_cartao); ?>
                                                                <?php echo render_input('numero_parcela','payment_numero_parcela',$payment->numero_parcela); ?>
                                                                <label>CPF na nota fiscal</label>
                                                                <?php if($payment->com_cpf_nota_fiscal == 1){ ?> 
                                                                <input class="form-group" type="checkbox"  checked="true"  value="1"   name="com_cpf_nota_fiscal" id="com_cpf_nota_fiscal">
                                                                <?php }else{ ?> 
                                                                <input class="form-group" type="checkbox"   value="1"  name="com_cpf_nota_fiscal" id="com_cpf_nota_fiscal">
                                                                <?php } ?> 
                                                                <br><br>
                                                                <?php echo render_input('nome_nota_fiscal','nome_nota_fiscal',$payment->nome_nota_fiscal); ?>
                                                                <?php echo render_input('cpf_nota_fiscal','cpf_nota_fiscal',$payment->cpf_nota_fiscal); ?>
