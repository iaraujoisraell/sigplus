 ...
 padding: 6px 12px;
	...
	<div class="content">
		<div class="row">
			...
			$this->load->view('admin/horario_plantao/list_template');
			?>
		</div>
	</div>

<?php $this->load->view('admin/includes/modals/sales_attach_file'); ?>
<?php $this->load->view('admin/horario_plantao/novo_horario'); ?>
...
<script>
  ...
  $(function(){
    ...
    var CustomersServerParams = {};
       ...
       var tAPI = initDataTable('.table-conta_pagar_parcelas', admin_url+'horario_plantao/table', [0], [0], CustomersServerParams, [1, 'desc']);
