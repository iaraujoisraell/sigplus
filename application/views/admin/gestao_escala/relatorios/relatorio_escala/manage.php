...
<div class="content">
    <div  class="row">
        <div class="col-md-12">
            ...
            <?php echo form_open('admin/Escala_plantoes/pdf'); ?>
              <div class="col-md-12">        
                <div class="col-md-4">
            ...
            <!--  <div class="col-md-4">
              ...
              -->
                    ...
                    <div class="box-header ">
                           ...
                           <!--<a href="<?php echo base_url('admin/Escala_plantoes/pdf')?>" class="btn btn-primary testando""><i class="fa fa-file-pdf-o"></i></a>-->
                           </div>
                    </div>
                </div>  
            </div>
    ...
    function filtraEscala() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo admin_url("Escala_plantoes/pdf"); ?>",
        data: {
