  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $event->escalado; ?></h4>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php if($event->userid == get_staff_user_id() || is_admin()){ ?>
              ...
              <label>Titular</label>
              <select  name="titular_id" id="titular_id" disabled="true" class="form-control">
                 <?php foreach($medicos as $medico){ 
                    $selected = '';
                        if($event->titular_id == $medico['medicoid']){
                         $selected = 'selected';
                       }
              ...
              <select  name="medico_escalado_id" id="medico_escalado_id" class="form-control">
                <option value="">Selecione o(s) Médico(s)</option>  
                 <?php foreach($medicos as $medico){ 
                    $selected = '';
                        if($event->medico_escalado_id == $medico['medicoid']){
                         $selected = 'selected';
                       }
              ...
              <select  name="titular_id" id="titular_id" disabled="true" class="form-control">
                 ...
                 <?php foreach($medicos as $medico){ 
                    $selected = '';
                        if($event->substituto == $medico['medicoid']){
                         $selected = 'selected';
                       }
              ...
              <select  name="titular_id" id="titular_id" disabled="true" class="form-control">
                 ...
                 <?php foreach($medicos as $medico){ 
                    $selected = '';
                        if($event->medico_plantonista_id == $medico['medicoid']){
                         $selected = 'selected';
                       }
