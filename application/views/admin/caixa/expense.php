   ...
   <div class="content">
      <div class="row">
         <?php
            ...
            //echo $caixa_atual; exit;
            
            if(is_admin() && (!$member->caixa_id)){
               // $caixa_atual = $caixa_id;
            }
          //   echo 'aqui : '.$caixa_atual; exit;
         ...
         <?php echo form_open(admin_url('caixas/caixa'),array('id'=>'fechar_caixa-form')); ?>
          ...
          <input type="hidden" name="valor_repasses" value="<?php echo $valor_repasse; ?>">
         <div class="col-md-6">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="btn-bottom text-right">
                      <a href="<?php echo admin_url('caixas'); ?>" class="btn btn-danger">CANCELAR</a>
                     <button type="submit" class="btn btn-success"><?php echo 'Fechar Caixa'; ?></button>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="panel-body">
                  ...
                  <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
                        ...
                        <tr>
                            ...
                            <td>
                              <?php echo _d($caixa['data_pagamento']);   ?>
                            </td>
                    ...
                    ?>
                        ...
                        <tr style="background-color: gray">
                            <td>
                                <b>RESUMO POR FORMA DE PAGAMENTO</b>
                            </td>
                            <td>
                        ...
                        <br>
                         <tr>
                            ...
                            <td >
                                <label><h2> <b><?php echo app_format_money($saldo_final, 'R$'); ?></b> </h2></label>
                            </td>
                            <td>
