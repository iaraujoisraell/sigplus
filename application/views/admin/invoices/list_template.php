...
<div class="col-md-12">
   <div class="panel_s mbot10">
    ...
    <div class="panel_s mbot10">
        <div class="panel-body _buttons">
        <div class="col-md-6">
            <input type="number" id="busca_fatura" name="busca_fatura" class="form-control" maxlength="6" placeholder="Informe o número da fatura">   
            <button  onclick="busca_fatura_reload();" class="btn btn-warning ">
                  <?php echo 'BUSCAR FATURA'; ?>
               </button>
            <a href="<?php echo admin_url('invoices'); ?>" class="btn btn-danger pull-right new new-invoice-list mright5"><?php echo 'Limpar'; ?></a>
            </div>
        </div>
    </div>
   <div class="row">
