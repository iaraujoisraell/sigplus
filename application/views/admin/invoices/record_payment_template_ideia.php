            ...
            <div class="row">
                ...
                <table class="table table-hover no-mtop">
                 <thead>
                    <tr>
                        ...
                        <th><span class="bold"><?php echo 'Id Transação'; ?></span></th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo render_date_input('date','record_payment_date',_d(date('Y-m-d'))); ?></td>
                        ...
                        <td><?php echo render_input('transactionid','payment_transaction_id'); ?></td>
                    </tr>  
                    <tr>
                        <td></td>
                        <td><?php echo render_input('nome_nota_fiscal','nome_nota_fiscal'); ?></td>
                        <td> <?php echo render_input('cpf_nota_fiscal','cpf_nota_fiscal'); ?></td>
                        <td><?php echo render_input('numero_cartao','payment_numero_cartao'); ?></td>
                        <td><?php echo render_input('numero_parcela','payment_numero_parcela'); ?></td>
                       
                    </tr>
                <?php foreach($contas as $conta){ ?>
                    <tr>
                        <td><input type="checkbox" name="do_not_redirect" checked><label><?php echo $conta['nome_profissional']; ?></label>  </td>
                        <td><?php echo render_date_input('date','record_payment_date',_d(date('Y-m-d'))); ?></td>
                        <td><div class="form-group">
                        <label for="paymentmode" class="control-label"><?php echo _l('payment_mode'); ?></label>
                        <select class="selectpicker" name="paymentmode" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                ...
                ?>
                <div class="checkbox checkbox-primary mtop15 inline-block">
                    <input type="checkbox" value="1" name="nao_emitir_nota_fiscal" id="nao_emitir_nota_fiscal">
