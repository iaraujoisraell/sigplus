          ...
          <div class="f_client_id">
              <div class="form-group select-placeholder">
               ...
               <?php $selected = (isset($invoice) ? $invoice->clientid : '');
                 ...
                 if($selected != ''){
                    ...
                    echo '<option value="'.$rel_val['id'].'" selected>'.$rel_val['userid'].'-'.$rel_val['name'].'</option>';
                 } ?>
                </select>
              </div>
            </div> 
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        echo render_select_required_true('medicoid',$medicos,array('medicoid',array('nome_profissional',  'especialidade')),'selecione_medico_encaminhamento',$selected);
                        ?>
                  </div>
                ...
                <div class="col-md-12">
                    <?php echo 'Convênio'; ?> 
                       ...
                       /* $selected = '';
                        ...
                        echo render_select_required_true('convenio',$convenios,array('id',array('name')),'convenio',$selected, array('name'));
                        * 
                        */
                        ?>
                    <br><br>
            ...
            <div class="panel_s no-shadow">
               ...
               <div class="form-group mbot15 select-placeholder">
                  ...
                  <select name="payment_modes" id="payment_modes" class="selectpicker"   data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            ...
                            <?php
                            $payment_mode = $invoice->payment_modes;
                            if($payment_mode){
                                echo '<option value=""   >TODOS</option>';   
                                echo '<option value="01" selected="true" >Dinheiro, Débito, PIX, Transferência</option>';   
                            }else{
             ...
             <?php $value = (isset($invoice) ? _d($invoice->data_execucao) : _d(date('Y-m-d')));?>
             <?php echo render_date_input('data_execucao','data_execucao',$value); ?>
         </div>
      </div>
   </div>
   <div class="panel-body mtop10">
      ...
      <div class="table-responsive s_table">
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
            ...
            <tbody>
               <tr class="main">
                  <td><input type="hidden"  name="item_id" class="form-control" style="width: 100px"></td></td>
                  <td>
                     <textarea readonly="true" name="description" class="form-control" rows="4" placeholder="<?php echo _l('item_description_placeholder'); ?>"></textarea>
                  </td>
                  <td>
                     <textarea readonly="true" name="long_description" rows="4" class="form-control" placeholder="<?php echo _l('item_long_description_placeholder'); ?>"></textarea>
                  </td>
                  <?php echo render_custom_fields_items_table_add_edit_preview(); ?>
                  <td>
                      
                      <input type="number" name="quantity" min="0" value="1" class="form-control" <?php if(!has_permission('invoices','','campo_qty')){ ?> readonly="true"  <?php } ?>  placeholder="<?php echo _l('item_quantity_placeholder'); ?>">
                     <input type="text" placeholder="<?php echo _l('unit'); ?>"  <?php if(!has_permission('invoices','','campo_qty')){ ?> readonly="true"  <?php } ?>   data-toggle="tooltip" data-title="e.q kg, lots, packs" name="unit" class="form-control input-transparent text-right">
                     
                  </td>
                  <td>
                    <input type="number"  name="rate"   class="form-control" <?php if(!has_permission('invoices','','campo_valor')){ ?> readonly="true"  <?php } ?> placeholder="<?php echo _l('item_rate_placeholder'); ?>">
                  </td>
                  ...
                  <td>
                      <div class="row">
                        <div class="input-group" id="discount-total">
                          <div class="col-md-12">
                            <input type="number" id="valor_desconto" <?php if(!has_permission('invoices','','campo_desconto')){ ?> readonly="true"  <?php } ?> name="valor_desconto" class="form-control" value="0.00" placeholder="<?php echo 'Desconto'; ?>">
                         ...
                         <!--  <input type="number" value="0.00" class="form-control pull-left input-discount-percent<?php //if(isset($estimate) && !is_sale_discount($estimate,'percent') && is_sale_discount_applied($estimate)){echo ' hide';} ?>" min="0" max="100" name="valor_desconto"> -->
                           ...
                           <div class="col-md-12">
                                <select name="destino_desconto" id="destino_desconto" <?php if(!has_permission('invoices','','campo_destino_desconto')){ ?> readonly="true"  <?php } ?>  class="form-control">
                  ...
                  <td>
                     <?php
                        ...
                        ?>
                      <button type="button" onclick="add_item_to_table('undefined','undefined',<?php echo $new_item; ?>); getElementById('valor_desconto').value = ''; return false;" class="btn pull-right btn-info"><i class="fa fa-check"></i></button>
                  </td>
               </tr>
