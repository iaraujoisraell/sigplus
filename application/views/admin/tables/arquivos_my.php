...
$join = [
    'LEFT JOIN ' . db_prefix() . '_intranet_arquivo_send ON ' . db_prefix() . ''_intranet_arquivo_send.arquivo_id = ' . db_prefix() . '_intranet_arquivo.id',
    ];
...
array_push($where, ' AND '.db_prefix() . '_intranet_arquivo_send.staff_id = '. get_staff_user_id() );
