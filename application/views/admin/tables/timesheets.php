...
foreach ($rResult as $aRow) {
    ...
    $options        = '';
    if (($aRow['staff_id'] == get_staff_user_id() || has_permission_intranet('projects', '', 'edit'))) {
        if (($aRow['staff_id'] == get_staff_user_id() || has_permission_intranet('projects', '', 'edit'))) {
        ...
        if (has_permission_intranet('projects', '', 'delete') || has_permission_intranet('tasks', '', 'delete') || $aRow['staff_id'] == get_staff_user_id()) {
