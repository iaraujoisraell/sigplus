...
$hasPermissionEdit   = has_permission_intranet('projects', '', 'edit');
$hasPermissionDelete = has_permission_intranet('projects', '', 'delete');
$hasPermissionCreate = has_permission_intranet('projects', '', 'create');
...
if (!has_permission_intranet('projects', '', 'view') || $this->ci->input->post('my_projects')) {
...
array_push($where, 'AND ' . db_prefix() . 'projects.deleted=0');
array_push($where, 'AND ' . db_prefix() . 'projects.empresa_id= '.$empresa_id);
