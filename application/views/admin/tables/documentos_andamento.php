...
$join = [
    ...
    //'Left JOIN ' . db_prefix() . '_intranet_documento_aprovacao ON ' . db_prefix() . '_intranet_documento_aprovacao.doc_id = ' . db_prefix() . '_intranet_documento.id',
...
array_push($where, 'AND tbl_intranet_documento.id in (select tbl_intranet_documento_aprovacao.doc_id from tbl_intranet_documento_aprovacao where tbl_intranet_documento_aprovacao.doc_id = tbl_intranet_documento.id and tbl_intranet_documento_aprovacao.staff_id = '.$id_usuario.')');
