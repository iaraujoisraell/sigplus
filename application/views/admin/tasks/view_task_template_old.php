                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <?php
                              if(!$task->billed){
                                   if(has_permission_intranet('tasks','','delete') || (has_permission('projects','','delete') && $task->rel_type == 'project') || $timesheet['staff_id'] == get_staff_user_id()){
                              ...
                              <div class="form-group">
                                 ...
                                 <select name="single_timesheet_staff_id" class="selectpicker" data-width="100%">
                                    <?php foreach($task->assignees as $assignee){
                                       if((!has_permission_intranet('tasks','','create') && !has_permission_intranet('tasks','','edit') && $assignee['assigneeid'] != get_staff_user_id()) || ($task->rel_type == 'project' && !has_permission('projects','','edit') && $assignee['assigneeid'] != get_staff_user_id())){continue;}
                                       $selected = '';
