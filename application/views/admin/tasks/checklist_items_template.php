            ...
            <div class="checklist" data-checklist-id="<?php echo $list['id']; ?>">
               <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  <textarea data-taskid="<?php echo $task_id; ?>" name="checklist-description" rows="1"<?php if($list['addedfrom'] != get_staff_user_id() && !has_permission_intranet('tasks','','edit')){echo ' disabled';} ?>><?php echo clear_textarea_breaks($list['description']); ?></textarea>
              </div>
              <div class="mleft5">
                <?php if(has_permission_intranet('tasks','','delete') || $list['addedfrom'] == get_staff_user_id()){ ?>
