...
<div class="modal fade" id="add_forma_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo 'Editar Forma de Pagamento'; ?></span>
                    <span class="add-title"><?php echo 'Add Forma de Pagamento'; ?></span>
                </h4>
            </div>
            <?php echo form_open('admin/financeiro/manage_modo_pagamento',array('id'=>'invoice_item_form')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select name="active" id="active" class="form-control">
                            <option checked value="1">ATIVO</option>
    ...
    $.post(url, data).done(function (response) {
        ...
        if (response.success == true) {
            ...
            if ($("body").find('.accounting-template').length > 0) {
                ...
                $('.table-forma_pgto').DataTable().ajax.reload(null, false);
            }
            alert_float('success', response.message);
        }
        $('#add_forma_modal').modal('hide');
    }).fail(function (data) {
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#add_forma_modal', function (event) {

        $('.affect-warning').addClass('hide');

        var $itemModal = $('#add_forma_modal');
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('financeiro/get_modo_pagamento_by_id/' + id).done(function (response) {
                $itemModal.find('input[name="id"]').val(response.id);
                $itemModal.find('input[name="name"]').val(response.name);
                $itemModal.find('#active').selectpicker('val', response.active);
    ...
    $("body").on("hidden.bs.modal", '#add_forma_modal', function (event) {
