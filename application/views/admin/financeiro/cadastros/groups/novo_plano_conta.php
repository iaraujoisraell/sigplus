        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    ...
                    <span class="add-title"><?php echo 'Add Plano de Conta'; ?></span>
                </h4>
            </div>
            <?php echo form_open('admin/financeiro/manage_plano_conta',array('id'=>'invoice_item_form')); ?>
            <?php echo form_hidden('id'); ?>
           
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_select('categoria_id',$categorias,array('id','name'),'categoria'); ?>
                        <?php echo render_input('descricao','invoice_item_add_edit_description'); ?>
                        <label>Natureza</label>
                        <select name="natureza" id="natureza" class="form-control">
                            <option checked="true" value="1">DESPESAS</option>
