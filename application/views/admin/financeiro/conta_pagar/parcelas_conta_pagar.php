    ...
    <div class="content">
            <div class="row">
                <section class="content-header">
                  <h1>
                   Parcelas Título : <?php echo $titulo->complemento; ?> 
                  </h1>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table dt-table scroll-responsive" id="table-parcelas-titulo" data-order-col="0" data-order-type="desc">
                                         <thead>
                                            ...
                                            <th><span class="bold"><?php echo 'Vl Desconto'; ?></span></th>
                                            <th><span class="bold"><?php echo 'Vl Parcela'; ?></span></th>
                                         ...
                                         <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo app_format_money($parc['desconto'], 'R$') ?></td>
                                               ...
                                               <td>
                                                  ...
                                                  if($status == 0){
                                                  ?>
                                                   <a class="btn btn-success new new-invoice-list mright5" href="<?php echo admin_url('financeiro/pagamento_parcelas_conta_pagar/'.$parc['id']); ?>" ><i class="fa fa-money"></i> </a>
                                                  ...
                                                  /*if(has_permission('credit_notes','','delete')){ ?>
                                                  <a href="#" class="btn btn-success pull-left new new-invoice-list mright5"  data-toggle="modal" data-target="#add_pgto_parcela_modal" data-id="<?php echo $parc['id']; ?>"><i class="fa fa-money"></i> <?php echo 'Pagar'; ?></a> 
                                                  <?php } */
