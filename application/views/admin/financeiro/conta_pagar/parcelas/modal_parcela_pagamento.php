...
<div class="modal fade" id="add_pgto_parcela_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/financeiro/manage_parcelas',array('id'=>'parcela_form2')); ?>
...
function manage_invoice_items(form) {
    ...
    $.post(url, data).done(function (response) {
        ...
        $('#add_pgto_parcela_modal').modal('hide');
    }).fail(function (data) {
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#add_pgto_parcela_modal', function (event) {

        $('.affect-warning').addClass('hide');

        var $itemModal = $('#add_pgto_parcela_modal');
    ...
    $("body").on("hidden.bs.modal", '#add_pgto_parcela_modal', function (event) {
