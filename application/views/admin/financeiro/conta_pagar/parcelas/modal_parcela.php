...
<div class="modal fade" id="add_parcela_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo 'Editar Parcela'; ?></span>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <br>
                        <label>Valor </label>
                        <input type="text"  name="valor_parcela" id="valor_parcela"  maxlength="10"   class="form-control" required="true">
                       <br>
                        <label>Data Vencimento</label>
                        <input type="date"  name="data_vencimento" id="data_vencimento" required="true"  class="form-control">
                        <br>
                        
                        <label>Número do Documento Parcela</label>
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#add_parcela_modal', function (event) {

        $('.affect-warning').addClass('hide');

        var $itemModal = $('#add_parcela_modal');
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('financeiro/get_parcela_by_id/' + id).done(function (response) {
                ...
                $itemModal.find('#forma_pagamento').selectpicker('val', response.forma_pagamento);
                $itemModal.find('input[name="data_pagamento"]').val(response.data_pagamento);
    ...
    $("body").on("hidden.bs.modal", '#add_parcela_modal', function (event) {
