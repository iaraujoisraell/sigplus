		...
		<div class="row">
			...
			<div class="col-md-12">
                            <section class="content-header">
                              <h1>
                               Add Títulos a Receber
                              </h1>
                              <ol class="breadcrumb">
                                <li><a href="<?php echo admin_url(''); ?>"><i class="fa fa-dashboard"></i> Financeiro </a></li>
                                <li><a href="<?php echo admin_url('financeiro_invoices'); ?>">Títulos a Receber</a></li>
                                <li class="active"><a href=""> Add Título </a></li>
                              </ol>
                            </section>
				<?php $this->load->view('admin/financeiro/contas_receber/invoice_template'); ?>
			</div>
			<?php echo form_close(); ?>
