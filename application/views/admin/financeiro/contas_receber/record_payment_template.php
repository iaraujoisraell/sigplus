...
<div class="content">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo admin_url(''); ?>">Pagamento de Fatura</a></li>
      </ol>
    </section>
        <div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_open(admin_url('financeiro_invoices/record_payment'),array('id'=>'record_payment_form')); ?>
        <?php echo form_hidden('invoiceid',$invoice->id); ?>
       
        
        <div class="panel-body">
            <h4 class="no-margin"><?php echo _l('record_payment_for_invoice'); ?> <?php echo format_invoice_number($invoice->id); ?> <label class="btn btn-primary pull-right"><?php echo app_format_money($invoice->total,' R$ '); ?></label></h4> 
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker" required="true" name="banco_id"  data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            
                            <option selected="true" value="1">Bancos</option>
                            <?php
                            foreach($bancos as $conta){ ?>
                            <option selected="true" value="<?php echo $conta['id']; ?>"><?php echo  $conta['banco']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
