                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile"><?php if ($empresa_id == 2) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"<?php if (has_permission('staff', '', 'edit')) { ?> name="data_nascimento"<?php } else { ?> disabled="true"<?php } ?> class="form-control" value="<?php echo $member->data_nascimento; ?>" id="data_nascimento">
                                        </div> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php } ?>
                                        <div class="checkbox checkbox-primary">
                                            <input type="checkbox" name="master_portal" id="master_portal" <?php if($member->master_portal == 1){ echo 'checked'; }?>>
