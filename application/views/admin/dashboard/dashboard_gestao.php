                   ...
                   <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                      <li role="presentation" class="active">
                       ...
                       <li role="presentation"  >
                         <a href="<?php echo admin_url('dashboard/dashboard_producao/'); ?>" >
            ...
            <div class="col-md-12 " data-container="top-12">
                <div class="row">
                    <div class="box " >
                        ...
                        <h3 class="box-title">DASHBOARD TESOURARIA / REPASSES</h3>    
                        <br><br>
                        <!-- CONTA MÉDICA -->
...
<script>
    function filtraDashboard() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo admin_url("dashboard/retorno_dashboard_gestao"); ?>",
        data: {
