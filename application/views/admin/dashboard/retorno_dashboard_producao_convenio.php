    ...
    <div id="conteudo"> 
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Produção 2022</h3>
               </div>
                      ...
                      <!-- PRODUÇÃO TOTAL -->
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                              ...
                              foreach($producao_total_2022 as $tesouraria){
                                $ano = $tesouraria['ano'];
                            ...
                            var chart = new google.charts.Bar(document.getElementById('columnchart_tesouraria_2022'));

                            chart.draw(data, google.charts.Bar.convertOptions(options));
                          }
                      </script>
                        <div id="columnchart_tesouraria_2022" style="width: 100%; height: 400px;"></div>
                    </div>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Produção 2021</h3>
               </div>
                 <!-- RECEBIMENTO PARTICULAR E VSOCIAL -->
                <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Performance Produção por Médico </h3>
                  ...
                  <div class="row">
                       ...
                       <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
                        ...
                        function drawChart() {
                          var data = google.visualization.arrayToDataTable([
                            ["Médico", "Produção", { role: "style" } ],
                             <?php
                              foreach($producao_resumo_medico as $tesouraria){
                                $medico = $tesouraria['medico'];
                                $valor = $tesouraria['valor_total'];
                                $color = $tesouraria['color'];
                                ?>
                                ['<?php echo $medico; ?>', <?php echo $valor ?>, '<?php echo $color ?>'],
                            <?php } ?>  
                          ]);
                          ...
                          var chart = new google.visualization.BarChart(document.getElementById("barchart_values_medico"));
                          chart.draw(view, options);
                      }
                      </script>
                      
                     <div id="barchart_values_medico" ></div>
                  </div>
               </div>       
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                        <img width="148px" height="108px" src="https://vision.sigplus.site/medicos vision/cavalcanti.jpg" alt="User Image">
                      <a class="users-list-name" href="<?php echo base_url("admin/dashboard/dashboard_producao_medico/3") ?>" target="_blank">Dr. Cavalcanti</a>
                     
                    </li>  
                    <li>
                      <img width="148px" height="108px" src="https://vision.sigplus.site/medicos vision/Dennis-Ramos-Web_2736_480x.png" alt="User Image">
                      <a class="users-list-name" href="<?php echo base_url("admin/dashboard/dashboard_producao_medico/5") ?>" target="_blank">Dr. Dennis Ramos</a>
                     
                    </li>
                    
                    <li>
                      <img width="148px" height="108px" src="https://vision.sigplus.site/medicos vision/fabiano-bivar-1.jpg" alt="User Image">
                      <a class="users-list-name" href="<?php echo base_url("admin/dashboard/dashboard_producao_medico/4") ?>" target="_blank">Dr. Fabiano Bivar</a>
                  
                    </li>
                    <li>
                      <img width="148px" height="108px" src="https://vision.sigplus.site/medicos vision/médico-3.jpg" alt="User Image">
                      <a class="users-list-name" href="<?php echo base_url("admin/dashboard/dashboard_producao_medico/6") ?>" target="_blank">Dr. Leonardo Bivar</a>
...
<div class="row">
                      ...
                      <tr>
                          ...
                          <td class="text-center"><?php echo $qtde_consulta; ?></td>
                           ...
                           <td class="text-center"><?php echo $qtde_exames; ?></td>
                            ...
                            <td><?php echo app_format_money($valor_total_faturado, 'R$'); ?></td>
                    </tr>
                      <?php
                  }
                  ?>
 ...
 <!-- PRODUÇÃO POR PROCEDIMENTO --> 
  <div class="col-md-12">
    <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Produção Resumida por Médico</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
        <!-- PRODUÇÃO POR CATEGORIA -->
         <div class="table-responsive">
            <table  id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
               <?php
                ...
                foreach ($producao_detalhes_resumo_medico as $dados_medico) {
                      ...
                      $convenio_nome        = $dados_medico['medico'];
                      $valor_total_faturado = $dados_medico['valor_total'];
                      ...
                      ?>
                      <tr>
                          <td  ><a   href="<?php echo base_url("admin/dashboard/dashboard_producao_medico/$medico_id") ?>" target="_blank"> <?php echo  $convenio_nome; ?> </a></td>
              ...
              <tfoot>
                  ...
                  <td><?php echo app_format_money($soma_valor_consulta, 'R$'); ?></td>
                  <?php
                  $tkt_medio_tt_consulta = $soma_valor_consulta/ $soma_qtde_consulta;
                  $tkt_medio_tt_consulta    = substr($tkt_medio_tt_consulta, 0, 5);
                  ?>
                  <td><?php echo app_format_money($tkt_medio_tt_consulta, 'R$'); ?></td>
                  <td class="text-center"><b><?php echo $soma_qtde_exames; ?></b></td>
                  <td><?php echo app_format_money($soma_valor_exames, 'R$'); ?></td>

                  <?php
                  $tkt_medio_tt_exames = $soma_valor_exames/ $soma_qtde_exames;
                  $tkt_medio_tt_exames    = substr($tkt_medio_tt_exames, 0, 5);
                  ?>
                  <td><?php echo app_format_money($tkt_medio_tt_exames, 'R$'); ?></td>

                  <td class="text-center"><b><?php echo $soma_qtde_cirurgia; ?></b></td>
                  <td><?php echo app_format_money($soma_valor_cirurgia, 'R$'); ?></td>

                  <?php
                  $tkt_medio_tt_cirurgia = $soma_valor_cirurgia/ $soma_qtde_cirurgia;
                  $tkt_medio_tt_cirurgia    = substr($tkt_medio_tt_cirurgia, 0, 5);
                  ?>
                  <td><?php echo app_format_money($tkt_medio_tt_cirurgia, 'R$'); ?></td>
                  <td><?php echo app_format_money($soma_total_repasse, 'R$'); ?></td>
                  <td><?php echo app_format_money($soma_total_faturado, 'R$'); ?></td>

                  <td><?php $res_per = $soma_perc/$cont_total; 
                  echo substr("$res_per", 0, 5).' %'; ?></td>
                </tr>    
                <tr>
                  <th>Médico</th>
