            ...
            <div class="col-md-12 " data-container="top-12">
                <div class="row">
                    <div class="box " >
                        ...
                        <h3 class="box-title">PRODUÇÃO MÉDICA</h3>    
                        <br><br>
                        <!-- CONTA MÉDICA -->
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           ...
                           <select class="selectpicker"
                                   ...
                                   data-title="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                       ...
                                       $selected = 'selected';
                                       ?>
                               <option  value="<?php echo $medico['medicoid']; ?>" selected="true"><?php echo $medico['nome_profissional']; ?></option>
                                <?php } ?>
                           </select>
                           </div>    
                        </div>
                       ...
                       CATEGORIA
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="form-group">
                           <label style="font-size: 18px;" for="categorias"><?php echo _l('expense_dt_table_heading_category'); ?></label>
                           <div class="form-group">
                           <select class="selectpicker"
                                   data-toggle="<?php echo $this->input->get('allowed_payment_modes'); ?>"
                        ...
                        <div class="col-md-6 col-xs-12">
                          <div class="form-group">
                           <label style="font-size: 18px;" for="categorias"><?php echo 'Procedimentos'; ?></label>
                            <?php
                                $selected = '';
                               /* foreach($medicos as $medico){
                                 if(isset($invoice)){
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                             <label style="font-size: 18px;">Data de:</label>
                            <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <label style="font-size: 18px;">Data até:</label>
                           <div class="form-group">
                       ...
                       <div class="box-header ">
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           <button class="btn btn-primary" onclick="filtraDashboard();">BUSCAR</button>
                           </div>
                       </div>
                    </div>
              </div>      
...
<script>
    function filtraDashboard() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo admin_url("medicos/retorno_producao_medico"); ?>",
        data: {
