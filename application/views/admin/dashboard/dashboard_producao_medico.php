                ...
                <div class="row">
                    <div class="box " >
                        <div class="box-header with-border ">
                            <h3 class="box-title">DASHBOARD <b> <?php echo $medicos->nome; ?></b></h3>    
                        <br><br>
                        <!-- CONTA MÉDICA -->
                        <input name="medico_id" id="medico_id" type="hidden" value="<?php echo $medicos->id; ?>">
                        <!-- CONVÊNIO -->
...
<script>
    function filtraDashboard() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo admin_url("dashboard/retorno_dashboard_producao_medico"); ?>",
        data: {
