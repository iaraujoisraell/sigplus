      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-balance-scale" aria-hidden="true"></i> <?php echo 'Relatórios de Tesouraria'; ?></h4>
                      <hr />
                      ...
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'payments-received_forma_pagamento'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('invoice_payments_received_resumo_forma_pagamento'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'payments-conta_financeira-received'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Pagamentos Recebidos por Conta Financeira'; ?></a>
                      </p>
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'payments-fluxo_caixa-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Fluxo de Caixa'; ?></a>
                      </p>
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'nota-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Notas Fiscais'; ?></a>
                      </p>
                  ...
                  <div id="currency" class="form-group hide">
                     ...
                     <div class="form-group hide" id="report-time">
                        ...
                        <select class="selectpicker" name="months-report" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <option value="today"><?php echo 'Hoje'; ?></option>
               ...
               <hr class="hr-panel-heading" />
               <?php $this->load->view('admin/reports/includes/sales_payments_conta_financeira'); ?>
               ...
               <?php $this->load->view('admin/reports/includes/sales_faturamento'); ?>
               <?php $this->load->view('admin/reports/includes/sales_custo'); ?>
               <?php $this->load->view('admin/reports/includes/sales_payments_resumo_forma_pagamento'); ?>
               <?php $this->load->view('admin/reports/includes/sales_income'); // Gráfico ?>
               <?php $this->load->view('admin/reports/includes/sales_payment_modes'); // Gráfico  ?>
               <?php $this->load->view('admin/reports/includes/sales_customers_groups'); // Gráfico  ?>
              <?php $this->load->view('admin/reports/includes/sales_faturamento_medico'); ?>
               <?php $this->load->view('admin/reports/includes/sales_agendamento'); ?>
               <?php $this->load->view('admin/reports/includes/sales_agendamento_resumo'); ?>
               
               <?php $this->load->view('admin/reports/includes/sales_items_medico'); ?>
               <?php $this->load->view('admin/reports/includes/sales_fluxo_caixa_ajax'); ?>
               <?php $this->load->view('admin/reports/includes/sales_nota_fiscal'); ?>
