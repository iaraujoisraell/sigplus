               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-balance-scale" aria-hidden="true"></i> <?php echo 'Relatórios de Faturamento'; ?></h4>
                      <hr />
                      
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'faturamento-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('relatorio_faturamento'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <p>
                       <a href="#" class="font-medium" onclick="init_report(this,'faturamento-producao-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Rel. Produção Médica'; ?></a> 
                      </p>
                      <hr class="hr-10" />
                      <p>
                       <a href="#" class="font-medium" onclick="init_report(this,'custo-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Rel. Custo'; ?></a> 
                      </p>
