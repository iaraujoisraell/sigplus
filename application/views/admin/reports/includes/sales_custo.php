...
<div id="custo-report" class="hide">
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">   
      ...
      <div class="col-md-3">
          <div class="form-group">
               ...
               <?php
                  ...
                  echo render_select('procedimento_custo', $procedimentos, array('itemid', array('description','group_name')), 'procedimentos', $selected,array('multiple'=>'true'));
                  ?>
            </div>
      ...
      <table class="table table-custo-report scroll-responsive">
         <thead>
            <tr>
