               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo 'Relatórios de Agendamentos'; ?></h4>
                      <hr />
                      
                     
                        <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'agendamentos-realizados'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Agendamentos Realizados'; ?></a>
                      </p>
                       
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'agendamentos-resumo'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Agendamentos Realizados - RESUMO'; ?></a>
                      </p>
