...
foreach ($milestones as $milestone) {
 ...
 $cpicker = '';
 if (has_permission_intranet('projects', '', 'create') && $milestone['id'] != 0) {
...
?>
<ul class="kan-ban-col milestone-column<?php if(!has_permission_intranet('projects','','edit') || $milestone['id'] == 0){echo ' milestone-not-sortable';}; ?>" data-col-status-id="<?php echo $milestone['id']; ?>" data-total-pages="<?php echo $total_pages; ?>">
  ...
  <div class="border-right panel_s">
   <div class="panel-heading panel-heading-bg <?php if ($milestone_color != '') {
    echo 'color-not-auto-adjusted color-white ';
      ...
      <?php if ($milestone['id'] != 0 && has_permission_intranet('projects','','edit')) { ?>
    ...
    <?php if ($milestone['id'] != 0 && (has_permission_intranet('tasks', '', 'create') || has_permission_intranet('projects', '', 'create'))) { ?>
      <a href="#" onclick="return false;" class="pull-right text-dark" data-placement="bottom" data-toggle="popover" data-content="
      <div class='text-center'><?php if (has_permission_intranet('tasks', '', 'create')) {
