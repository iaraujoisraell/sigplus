                ...
                <div class="panel-body">
                    <div class="_buttons">
                        <?php if (has_permission_intranet('projects', '', 'create')) { ?>
                            ...
                            <a class="btn btn-info pull-left display-block mright5" data-toggle="modal" data-target="#categorias_modal">
                                Categorias
                            </a>
                        <?php } ?>
                        ...
                        <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right width300">
                                ...
                                <?php foreach ($statuses as $status) { ?>
                                    ...
                                    ?>">
                                        <a href="#" data-cview="<?php echo 'project_status_' . $status['id']; ?>" onclick="dt_custom_view('project_status_<?php echo $status['id']; ?>', '.table-projects', 'project_status_<?php echo $status['id']; ?>');
                                                return false;">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open("admin/Projects/add_categoria", array("id" => "ci-form", "enctype" => "multipart/form-data", "class" => "general-form", "role" => "form")); ?>
                <div class="input-group">
                    <input type="text" name="descricao" id="categoria_name" class="form-control" placeholder="<?php echo 'Nome'; ?>">
                            ...
                            <tbody>
                                <?php foreach ($categorias as $group) { ?>
                                    <tr class="row-has-options" data-group-row-id="<?php echo $group['id']; ?>">
                                        ...
                                        <td>
                                            <span class="group_name_plain_text" id="sair<?php echo $group['id']; ?>"><?php echo $group['descricao']; ?></span>
                                            <div class="group_edit hide" id="entrar<?php echo $group['id']; ?>">
                                                <?php echo form_open("admin/Projects/add_categoria", array("id" => " cate-form", "enctype" => "multipart/form-data", "class" => "general-form", "role" => "form")); ?>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="descricao" value="<?php echo $group['descricao']; ?>">
                                            ...
                                            <div class="row-options">
                                                ...
                                                <a href="<?php echo base_url('admin/Projects/delete_categoria' . '?id=' . $group['id']); ?>" class="edit-item-group text-danger">
                                                    <?php echo _l('delete'); ?>
                                                </a>
