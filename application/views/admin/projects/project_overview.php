      ...
      <div class="col-md-7">
         <table class="table no-margin project-overview-table">
            <tbody>
              ...
              <tr class="project-overview-customer">
                  <td class="bold">Analista</td>
                  <td><?php echo $project->analista_data->firstname.' '.$project->analista_data->lastname; ?></td>
              </tr><!-- comment -->
              <tr class="project-overview-customer">
                  <td class="bold">Gerente</td>
                  <td><?php echo $project->gerente_data->firstname.' '.$project->gerente_data->lastname; ?></td>
              </tr>
               <?php if(has_permission_intranet('projects','','edit')){ ?>
         ...
         <?php } ?>
         <?php if(has_permission_intranet('projects','','create')){ ?>
...
<div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info">Objetivo</p>
   <?php if(empty($project->objetivo)){
      echo '<p class="text-muted no-mbot mtop15">' . 'Objetivo' . '</p>';
   }
   echo check_for_links($project->objetivo); ?>
</div>
<div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info">Justificativa</p>
   <?php if(empty($project->justificativa)){
      echo '<p class="text-muted no-mbot mtop15">' . 'Justificativa' . '</p>';
   }
   echo check_for_links($project->justificativa); ?>
</div><!-- comment -->
<div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info">Benefícios</p>
   <?php if(empty($project->beneficios)){
      echo '<p class="text-muted no-mbot mtop15">' . 'Benefícios' . '</p>';
   }
   echo check_for_links($project->beneficios); ?>
</div>
<div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info">Restrições</p>
   <?php if(empty($project->restricoes)){
      echo '<p class="text-muted no-mbot mtop15">' . 'Restrições' . '</p>';
   }
   echo check_for_links($project->restricoes); ?>
</div><!-- comment -->
<div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info">Premissas</p>
   <?php if(empty($project->premissas)){
      echo '<p class="text-muted no-mbot mtop15">' . 'Premissas' . '</p>';
   }
   echo check_for_links($project->premissas); ?>
</div>
   ...
   <div class="media">
      ...
      <div class="media-body">
         ...
         <h5 class="media-heading mtop5"><a href="<?php echo admin_url('profile/'.$member["staff_id"]); ?>"><?php echo get_staff_full_name($member['staff_id']); ?></a>
            <?php if(has_permission_intranet('projects','','create') || $member['staff_id'] == get_staff_user_id()){ ?>
