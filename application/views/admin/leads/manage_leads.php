                           ...
                           <div class="row">
                              ...
                              <?php //if(has_permission('leads','','view')){ ?>
                               <div class="col-md-3 leads-filter-column">
                                 <?php echo render_select('campanha_id',$campanhas,array('id',array('titulo')),'Campanhas',$selected,array('onchange'=>'procedimentos_table_reload()'),array('data-width'=>'100%','data-none-selected-text'=>'Campanhas'),array(),'no-mbot'); ?>
                              </div>
                              <div class="col-md-3 leads-filter-column">
...
<script>
  ...
  $(function(){
    ...
    var CustomersServerParams = {};
       ...
       CustomersServerParams['campanha_id'] = '[name="campanha_id"]';
       CustomersServerParams['view_assigned'] = '[name="view_assigned"]'; 
       CustomersServerParams['view_status'] = '[name="view_status"]';
       CustomersServerParams['view_source'] = '[name="view_source"]';
       var tAPI = initDataTable('.table-leads', admin_url+'leads/table', [0], [0], CustomersServerParams, [1, 'desc']);
