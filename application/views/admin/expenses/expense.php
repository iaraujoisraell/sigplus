   ...
   <div class="content">
      <div class="row">
         <?php
            ...
            if (!$member->caixa_id){
                $msg_cx_fechado = "CAIXA FECHADO!!! ABRA UM CAIXA PARA FAZER MOVIMENTAÇÕES";
            }
            ?>
         <?php echo form_open_multipart($this->uri->uri_string(),array('id'=>'expense-form','class'=>'dropzone dropzone-manual')) ;?>
          <input type="input" name="caixa_id" value="<?php echo $caixa_atual; ?>">
         <div class="col-md-6">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php if (!$member->caixa_id){ ?>
                  <btn class="btn btn-danger"><?php echo $msg_cx_fechado; ?></btn>
                  <?php } ?>
