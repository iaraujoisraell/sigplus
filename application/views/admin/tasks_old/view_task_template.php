...
<div class="modal-body">
   <div class="row">
      ...
      <div class="col-md-4 task-single-col-right">
         ...
         <!-- Formulário upload de arquivo PDF -->
         <form id="upload-arquivo">
            <label>Arquivo: </label>

            <!-- Campo para o usuário selecionar arquivo -->
...
if (cadForm) {
    ...
    cadForm.addEventListener("submit", async (e) => {
        ...
        // Validar extensão do arquivo
            ...
            const dados = await fetch("<?php echo base_url(); ?>controle_upload/tasks.php?task_id=<?php echo $task->id; ?>", {
                method: "POST",
                body: dadosForm
            });
           // alert('aqui'); exit;
