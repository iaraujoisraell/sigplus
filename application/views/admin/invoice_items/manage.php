  ...
  <div class="content">
    ...
    <div class="row">
     ...
     <?php if(has_permission('items','','create')){ ?>
       <div class="_buttons">
        <a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#sales_item_modal"><?php echo 'Novo Procedimento'; ?></a>
       <!-- <a href="<?php //echo admin_url('invoice_items/add_procedimento_medicos'); ?>" class="btn btn-info pull-left mleft5" ><?php echo 'Add Procedimento/Médico'; ?></a> -->
