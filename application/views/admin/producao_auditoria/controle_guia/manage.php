        ...
        <div class="panel_s">
         ...
         <!--   <div class="col-md-12">
            ...
            <div class="panel_s">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                  <label for="convenios"><?php echo 'Status Guia'; ?></label>
                  <div class="form-group">
                   <select onchange="procedimentos_table_reload()" class="selectpicker"
                           data-toggle="<?php echo $this->input->get('allowed_payment_modes'); ?>"
              ...
              <div class="col-md-3">
                  <div class="form-group">
                      ...
                      <input onkeyup="procedimentos_table_reload()" type="date" name="data_ate" value="<?php echo $hoje; ?>" data-width="100%" class="form-control" id="data_ate">
                    </div>
              ...
              <hr class="hr-panel-heading" />
                  <a href="#" data-toggle="modal" data-target="#customers_bulk_action" class="bulk-actions-btn table-btn hide" data-table=".table-controle_guias"><?php echo _l('bulk_actions'); ?></a>
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <?php if (has_permission('faturamento_menu', '', 'receber_guia')) { ?>
                              <div class="checkbox checkbox-danger">
                                 <input type="checkbox" name="mass_approved" id="mass_approved">
                                 <label for="mass_approved"><?php echo 'Confirmar Recebimento'; ?></label>
                              </div>
                               <?php } ?>
                               
                              <hr class="mass_delete_separator" />
                              <?php if (has_permission('faturamento_menu', '', 'cancelar_receber_guia')) { ?>
                              <div class="checkbox checkbox-danger">
                                 <input type="checkbox" name="mass_deleted" id="mass_deleted">
                                 <label for="mass_deleted"><?php echo 'Cancelar Recebimento'; ?></label>
                              </div>
                              <?php } ?>
            ...
            //if (!has_permission('faturamento_menu', '', 'view')) {
              //$table_data[] = '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="invoice-items"><label></label></div>';
                $table_data[] = '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="controle_guias"><label></label></div>';
            //}
            ...
            render_datatable($table_data,'controle_guias'); ?>
          </div>
</div>
</div>
</div>
...
<script>
  ...
  $(function(){
    ...
    var CustomersServerParams = {};
     ...
     //  CustomersServerParams['exclude_inactive'] = '[name="exclude_inactive"]:checked';
       var tAPI = initDataTable('.table-controle_guias', admin_url+'Producao_auditoria/table_controle_guias', [0], [0], CustomersServerParams, [1, 'desc']);
   ...
   function procedimentos_table_reload() {
     ...
     if ($.fn.DataTable.isDataTable('.table-controle_guias')) {
       $('.table-controle_guias').DataTable().destroy();
     }
      var tAPI = initDataTable('.table-controle_guias', admin_url+'producao_auditoria/table_controle_guias', [0], [0], CustomersServerParams, [1, 'desc']);
   // tAPI.ajax.reload();
  ...
  function customers_bulk_action(event) {
       ...
       if (r == false) {
           ...
           var cont_ids = 0;
           var rows = $('.table-controle_guias').find('tbody tr');
           $.each(rows, function() {
           ...
           setTimeout(function(){
             ...
             $.post(admin_url + 'producao_auditoria/bulk_action_controle_guias', data).done(function() {
