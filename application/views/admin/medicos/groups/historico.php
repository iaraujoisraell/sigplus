...
<div class="col-md-12">
 ...
 <a href="#" class="btn btn-success mtop15 mbot10" onclick="slideToggle('.usernote'); return false;"><?php echo _l('new_historico'); ?></a>
            ...
            <tr>
             ...
             <?php  if(!empty($note['data_visita'])){ ?>
              ...
              <?php echo date("d/m/Y", strtotime($note[ 'data_visita']));   ?>
                ...
                <td width="50%">
                  <div data-historico-description="<?php echo $note['id']; ?>">
                    <?php echo check_for_links($note['historico']); ?>
                </div>
                <div data-historico-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    <textarea name="description" class="form-control" rows="4"><?php echo clear_textarea_breaks($note['historico']); ?></textarea>
                    <div class="text-right mtop15">
                      <button type="button" class="btn btn-default" onclick="toggle_edit_historico(<?php echo $note['id']; ?>);return false;"><?php echo _l('cancel'); ?></button>
                      <button type="button" class="btn btn-info" onclick="edit_historico(<?php echo $note['id']; ?>);"><?php echo _l('update_note'); ?></button>
                  </div>
              </div>
          </td>
