      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-gears" aria-hidden="true"></i> <?php echo 'Agenda Médica'; ?></h4>
                      <hr />
                      <p>
                        <a href="#" class="font-medium active" onclick="init_agenda(this,'medicos-parametrizacao-agenda'); return true;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Parametrizar Agenda'; ?></a>
                      </p>
                        <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_agenda(this,'items-medico-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo 'Agendamentos'; ?></a>
                      </p>
               ...
               <h4 class="no-mtop"><?php echo 'Agendas Cadastradas'; ?></h4>
               <hr class="hr-panel-heading" />
               <?php //$this->load->view('admin/reports/includes/sales_invoices'); ?>
               <?php $this->load->view('admin/medicos/agenda/includes/agenda_medico'); ?>

               <?php $this->load->view('admin/medicos/agenda/includes/sales_items_medico'); ?>
...
<?php init_tail(); ?>
<?php $this->load->view('admin/medicos/agenda/includes/medico_js'); ?>
