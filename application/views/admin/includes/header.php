...
<div id="header">
   ...
   <!-- agenda -->
   <div id="logo">
      <!--  <a class="btn btn-warning" target="_blank" href="<?php echo admin_url('appointly/appointments'); ?>" ><i class="fa fa-calendar"> AGENDA</i></a> -->
   </div>
   
   <!-- agenda -->
   <div id="logo">
       <!-- <a class="btn btn-danger" target="_blank" href="<?php echo admin_url('appointly/appointments/agenda_medica'); ?>" ><i class="fa fa-calendar"> AGENDA MÉDICA</i></a> -->
   </div>
      ...
      <div class="mobile-menu">
         ...
         <div class="mobile-navbar collapse" id="mobile-collapse" aria-expanded="false" style="height: 0px;" role="navigation">
            <ul class="nav navbar-nav">
               <li class="header-my-profile"><a href="<?php echo base_url('gestao_corporativa/intranet/meu_perfil'); ?>"><?php echo _l('nav_my_profile'); ?></a></li>
