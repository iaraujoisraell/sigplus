    ...
    <body class="g-sidenav-show  bg-gray-200">
                                            ...
                                            <div class="col-md-8 d-flex align-items-center">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <p class="text-sm">
                                                            Por favor, informe o período que deseja ver o histórico de títulos registrados.
                                                        </p>
                                                        <?php if($permission_nothing == true){?>
                                                       <!-- <a href="<?php echo base_url(); ?>portal/financeiro/anything_pdf" target="_blanck">
                                                            <span class="material-icons alert-icon align-middle">
                                                                picture_as_pdf
                                                            </span> GERAR DECLARAÇÃO NADA CONSTA

                                                        </a><br>
                                                        <?php }?>
                                                        <a href="<?php echo base_url(); ?>portal/financeiro/annualstatement_pdf" target="_blanck">
                                                            <span class="material-icons alert-icon align-middle">
                                                                picture_as_pdf
                                                            </span> GERAR DECLARAÇÃO ANUAL DE QUITAÇÃO DE DÉBITOS
                                            ...
                                            <div class="col-md-4 text-center">
                                                <ul class="list-group ">
                                                    ...
                                                    <li class="list-group-item border-0 d-flex  mb-2 bg-gray-100 border-radius-lg">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <span class="mb-2 text-xs">Início</span>

                                                                <span class="mb-2 text-xs">
                                                                    <div class="input-group input-group-outline text-center">
                                                                        <input onkeyup="verify();" name="de" id="de"  class="text-center multisteps-form__input form-control" type="date" placeholder="de"/>
                                                                    </div>
                                                                </span>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <span class="mb-2 text-xs">Fim</span>

                                                                <span class="mb-2 text-xs">
                                                                    <div class="input-group input-group-outline text-center">
                                                                        <input onkeyup="verify();" name="ate" id="ate"  class="text-center multisteps-form__input form-control" type="date" placeholder="ate"/>
                                                                    </div>
                                                                </span>
                                                            </div>
                                                            <div class="col-md-12 mt-2">
                                                                <a href="javascript:;">
                                                                    <button class="btn bg-gradient-info mb-0 mx-auto" onclick="search();" id="button_search" disabled="true">Buscar Período</button>
                                                                </a>
                                                            </div>
                                                        </div>
        ...
        <script>
                                    ...
                                    function search() {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "<?php echo base_url('portal/financeiro/search_history'); ?>",
                                            data: {
                                                de: de,
                                                ate: ate,
