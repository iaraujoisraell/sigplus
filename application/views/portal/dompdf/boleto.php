...
$dadosboleto["logo_unimed"] = base_url().'uploads/imagens_banco/logo.png';
$dadosboleto["logo_ans"] = base_url().'uploads/imagens_banco/ans.png';
$dadosboleto["imagem_banco_6"] = base_url().'uploads/imagens_banco/6.png';
$dadosboleto["imagem_banco_3"] = base_url().'uploads/imagens_banco/3.png';
$dadosboleto["imagem_banco_2"] = base_url().'uploads/imagens_banco/2.png';
$dadosboleto["imagem_banco_1"] = base_url().'uploads/imagens_banco/1.png';

$dadosboleto["imagem_banco_p"] = base_url().'imagens/p.png';
$dadosboleto["imagem_banco_b"] = base_url().'imagens/b.png';

$this->load->view('portal/dompdf/layout.php', $dadosboleto);
//include("layout.php");
...
//$this->load->view('portal/dompdf/html2pdf/html2pdf.class.php', $dadosboleto);
//require_once(base_url().'portal/dompdf/html2pdf.class.php');
//$this->load->view(base_url().'portal/dompdf/html2pdf.class.php');
