                            ...
                            if ($request['status'] == 0) {
                                    ...
                                    <div class="modal fade" id="resquest_<?php echo $request['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <?php echo form_open_multipart(base_url('portal/workflow/finish_external_request/' . $workflow->id), array('onsubmit' => "document.getElementById('disabled').disabled = true;", "id" => "finish_external_request" . $workflow->id)); ?>
                                ...
                                <script>
                                    $(document).ready(function () {
                                        $('#finish_external_request<?php echo $workflow->id; ?>').submit(function (e) {
                                            e.preventDefault(); // Prevent the default form submission
                                            var uploadForm = $('#finish_external_request<?php echo $workflow->id; ?>');
                                            var formData = new FormData($('#finish_external_request<?php echo $workflow->id; ?>')[0]);
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (response) {
                                                    ...
                                                    $('#finish_external_request<?php echo $workflow->id; ?>').unbind('submit').submit();
                            ...
                            <div class="card-body p-3 pt-0">
                                ...
                                <div class="row">
                                            ...
                                            <?php if ($workflow->status != 4) { ?>
                                                    ...
                                                    <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            foreach ($requests as $request) {
                                                                ...
                                                                ?>
                                                                <?php
                                                                $values = $this->Categorias_campos_model->get_values($request['id'], 'external_request_workflow'); print_r($values); exit;
                                                ...
                                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        ?>
                                                        <?php
                                                        $values = $this->Categorias_campos_model->get_values($workflow->id, 'workflow', '', false, true);
                                    ...
                                    <div class="col-lg-8 col-12 ms-auto mt-5">
                                        ...
                                        $values_info['campos'] = $this->Categorias_campos_model->get_values($workflow->id, 'workflow', true, false, false, false, true); echo "<pre>";print_r($values_info['campos']);
