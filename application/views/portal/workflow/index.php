                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-xl-12 mt-md-0 position-relative">
                            ...
                            <div class="card card-plain h-100"  id="card-plain-add" style="display: none;">
                                ...
                                <?php echo form_open_multipart(base_url('portal/workflow/add'), array('onsubmit' => "document.getElementById('disabled').disabled = true;", "id" => "workflow_form")); ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($workflows as $workflow) { ?>
                                            <tr>
                                                ...
                                                <td class="text-sm font-weight-normal"><a class="btn btn-sm btn-warning mb-0 mx-auto" href="<?php echo base_url(); ?>portal/workflow/workflow/<?php echo $workflow['id']; ?>">Acompanhar</a></td>
                                            </tr>
                                        <?php } ?>
            ...
            <script>
                                                ...
                                                function escolha(opcaoValor) {
                                                    ...
                                                    if (opcaoValor != "") {
                                                        $.ajax({
                                                            type: "GET",
                                                            url: "<?php echo base_url('portal/Workflow/campos'); ?>",
                                                            data: {
