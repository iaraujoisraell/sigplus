                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <table class="table table-flush" id="datatable-search">
                            ...
                            <tbody>
                                <?php foreach ($registros as $ro) { // echo openssl_encrypt($ro['id'], "aes-256-cbc", 'sigplus', 0, 'sigplus'); exit; 
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal"><a class="btn btn-sm btn-warning mb-0 mx-auto" href="<?php echo base_url(); ?>portal/registro_ocorrencia/registro?id=<?php echo $ro['id']; ?>">Acompanhar</a></td>
                                    </tr>
                                <?php } ?>
