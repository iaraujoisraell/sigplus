...
$quick_access = (int) $this->session->userdata('portal_quick_access') === 1;
?>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main" translate="no">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?php echo $quick_access ? base_url('portal/financeiro/index') : base_url('portal/dashboard/index'); ?>">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mb-2 mt-0">
                ...
                <div class="collapse" id="ProfileNav">
                    <ul class="nav">
                        <?php if (!$quick_access && $this->session->userdata('categoria_id') == '9') { ?>
                            <li class="nav-item">
            ...
            <?php if ($this->session->userdata('categoria_id') == '9') { ?>
                ...
                <?php if (!$quick_access) { ?>
                    <li class="nav-item">
                        <a href="<?php echo base_url(); ?>portal/dashboard/index" class="nav-link text-white active">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('portal/financeiro/index'); ?>">
                        <span class="material-icons-round opacity-10">receipt_long</span>
                ...
                <?php if (!$quick_access) { ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>portal/Appointments">
                            <span class="material-icons-round opacity-10">calendar_month</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white <?php echo isset($active_fin) ? $active_fin : ''; ?>" style="<?php echo isset($backgroud_fin) ? $backgroud_fin : ''; ?>" data-bs-toggle="collapse" aria-expanded="false" href="#profileExample">
