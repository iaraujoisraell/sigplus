<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
		...
		<div class="form-group" style="padding-top:50px">
			...
			<input type="text" autofocus="true" class="form-control" value="demo@themesic.com" name="email" id="email">
			<?php echo form_error('email'); ?>
		</div>
		<div class="form-group">
			<label for="password"><?php echo _l('clients_login_password'); ?></label>
			<input type="password" class="form-control" value="demo1234" name="password" id="password">
