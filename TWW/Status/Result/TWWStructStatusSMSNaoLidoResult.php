<?php
/**
 * File for class TWWStructStatusSMSNaoLidoResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMSNaoLidoResult originally named StatusSMSNaoLidoResult
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMSNaoLidoResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for StatusSMSNaoLidoResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSNaoLidoResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSNaoLidoResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
