<?php
/**
 * File for class TWWStructStatusSMS2SNResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMS2SNResult originally named StatusSMS2SNResult
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMS2SNResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for StatusSMS2SNResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMS2SNResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMS2SNResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
