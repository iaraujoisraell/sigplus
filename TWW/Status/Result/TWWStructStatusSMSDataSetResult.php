<?php
/**
 * File for class TWWStructStatusSMSDataSetResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMSDataSetResult originally named StatusSMSDataSetResult
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMSDataSetResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for StatusSMSDataSetResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSDataSetResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSDataSetResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
