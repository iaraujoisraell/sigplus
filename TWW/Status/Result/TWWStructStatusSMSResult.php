<?php
/**
 * File for class TWWStructStatusSMSResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMSResult originally named StatusSMSResult
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMSResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for StatusSMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructStatusSMSResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
