<?php
/**
 * File for class TWWStructStatusSMSNaoLido
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMSNaoLido originally named StatusSMSNaoLido
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMSNaoLido extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Senha;
	/**
	 * Constructor method for StatusSMSNaoLido
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @return TWWStructStatusSMSNaoLido
	 */
