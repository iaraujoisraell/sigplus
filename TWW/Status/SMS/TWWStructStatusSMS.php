<?php
/**
 * File for class TWWStructStatusSMS
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructStatusSMS originally named StatusSMS
 ...
 * @date 2013-12-04
 */
class TWWStructStatusSMS extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $SeuNum;
	/**
	 * Constructor method for StatusSMS
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @param string $_seuNum
	 * @return TWWStructStatusSMS
	 */
