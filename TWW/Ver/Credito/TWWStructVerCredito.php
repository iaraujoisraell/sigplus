<?php
/**
 * File for class TWWStructVerCredito
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructVerCredito originally named VerCredito
 ...
 * @date 2013-12-04
 */
class TWWStructVerCredito extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Senha;
	/**
	 * Constructor method for VerCredito
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @return TWWStructVerCredito
	 */
