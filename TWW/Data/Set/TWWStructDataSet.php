<?php
/**
 * File for class TWWStructDataSet
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructDataSet originally named DataSet
 ...
 * @date 2013-12-04
 */
class TWWStructDataSet extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructDataSet::setSchema()
