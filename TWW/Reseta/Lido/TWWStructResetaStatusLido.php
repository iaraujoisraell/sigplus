<?php
/**
 * File for class TWWStructResetaStatusLido
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructResetaStatusLido originally named ResetaStatusLido
 ...
 * @date 2013-12-04
 */
class TWWStructResetaStatusLido extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Senha;
	/**
	 * Constructor method for ResetaStatusLido
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @return TWWStructResetaStatusLido
	 */
