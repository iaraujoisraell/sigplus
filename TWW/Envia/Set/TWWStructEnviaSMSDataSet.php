<?php
/**
 * File for class TWWStructEnviaSMSDataSet
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSDataSet originally named EnviaSMSDataSet
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSDataSet extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $DS;
	/**
	 * Constructor method for EnviaSMSDataSet
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @param TWWStructDS $_dS
	 * @return TWWStructEnviaSMSDataSet
	 */
