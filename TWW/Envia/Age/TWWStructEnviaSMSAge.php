<?php
/**
 * File for class TWWStructEnviaSMSAge
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSAge originally named EnviaSMSAge
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSAge extends TWWWsdlClass
{
	/**
	 * The Agendamento
	 * Meta informations extracted from the WSDL
	...
	public $Mensagem;
	/**
	 * Constructor method for EnviaSMSAge
