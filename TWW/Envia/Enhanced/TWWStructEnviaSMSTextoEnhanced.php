<?php
/**
 * File for class TWWStructEnviaSMSTextoEnhanced
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSTextoEnhanced originally named EnviaSMSTextoEnhanced
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSTextoEnhanced extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $texto;
	/**
	 * Constructor method for EnviaSMSTextoEnhanced
	 ...
	 * @param string $_texto
	 * @return TWWStructEnviaSMSTextoEnhanced
	 */
	public function __construct($_numUsu = NULL,$_senha = NULL,$_seuNum = NULL,$_celular = NULL,$_texto = NULL)
	{
		parent::__construct(array('NumUsu'=>$_numUsu,'Senha'=>$_senha,'SeuNum'=>$_seuNum,'Celular'=>$_celular,'texto'=>$_texto));
	}
	/**
	 * Get NumUsu value
	 * @return string|null
