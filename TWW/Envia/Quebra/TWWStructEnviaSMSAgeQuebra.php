<?php
/**
 * File for class TWWStructEnviaSMSAgeQuebra
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSAgeQuebra originally named EnviaSMSAgeQuebra
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSAgeQuebra extends TWWWsdlClass
{
	/**
	 * The Agendamento
	 * Meta informations extracted from the WSDL
	...
	public $Mensagem;
	/**
	 * Constructor method for EnviaSMSAgeQuebra
	 ...
	 * @return TWWStructEnviaSMSAgeQuebra
	 */
	public function __construct($_agendamento,$_numUsu = NULL,$_senha = NULL,$_seuNum = NULL,$_celular = NULL,$_mensagem = NULL)
	{
		parent::__construct(array('Agendamento'=>$_agendamento,'NumUsu'=>$_numUsu,'Senha'=>$_senha,'SeuNum'=>$_seuNum,'Celular'=>$_celular,'Mensagem'=>$_mensagem));
	}
	/**
