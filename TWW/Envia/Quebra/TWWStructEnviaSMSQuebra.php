<?php
/**
 * File for class TWWStructEnviaSMSQuebra
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMSQuebra originally named EnviaSMSQuebra
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMSQuebra extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Mensagem;
	/**
	 * Constructor method for EnviaSMSQuebra
	 ...
	 * @return TWWStructEnviaSMSQuebra
	 */
	public function __construct($_numUsu = NULL,$_senha = NULL,$_seuNum = NULL,$_celular = NULL,$_mensagem = NULL)
	{
		parent::__construct(array('NumUsu'=>$_numUsu,'Senha'=>$_senha,'SeuNum'=>$_seuNum,'Celular'=>$_celular,'Mensagem'=>$_mensagem));
	}
	/**
	 * Get NumUsu value
	 * @return string|null
