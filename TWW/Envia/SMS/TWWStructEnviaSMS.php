<?php
/**
 * File for class TWWStructEnviaSMS
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructEnviaSMS originally named EnviaSMS
 ...
 * @date 2013-12-04
 */
class TWWStructEnviaSMS extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Mensagem;
	/**
	 * Constructor method for EnviaSMS
