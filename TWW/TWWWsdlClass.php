<?php
/**
 * File for TWWWsdlClass to communicate with SOAP service
 * @package TWW
 ...
 */
/**
 * TWWWsdlClass to communicate with SOAP service
 * Documentation : Com esses serviços você pode enviar mensagens por CapCode para o sistema Reluz.
 * @package TWW
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @version 20131125-01
 * @date 2013-12-04
 */
class TWWWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses TWWWsdlClass::setLastError()
	 * @uses TWWWsdlClass::initSoapClient()
	 * @uses TWWWsdlClass::initInternArrayToIterate()
	 * @uses TWWWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'TWWWsdlClass'))
			{
	 ...
	 * @uses TWWClassMap::classMap()
	 * @uses TWWWsdlClass::getDefaultWsdlOptions()
	 * @uses TWWWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('TWWClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = TWWClassMap::classMap();
	 ...
	 * @uses TWWWsdlClass::WSDL_CACHE_WSDL
	 * @uses TWWWsdlClass::WSDL_COMPRESSION
	 * @uses TWWWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses TWWWsdlClass::WSDL_ENCODING
	 * @uses TWWWsdlClass::WSDL_EXCPTS
	 * @uses TWWWsdlClass::WSDL_FEATURES
	 * @uses TWWWsdlClass::WSDL_LOGIN
	 * @uses TWWWsdlClass::WSDL_PASSWD
	 * @uses TWWWsdlClass::WSDL_SOAP_VERSION
	 * @uses TWWWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses TWWWsdlClass::WSDL_TRACE
	 * @uses TWWWsdlClass::WSDL_TYPEMAP
	 * @uses TWWWsdlClass::WSDL_URL
	 * @uses TWWWsdlClass::WSDL_USER_AGENT
	 ...
	 * @uses TWWWsdlClass::getSoapClient()
	 * @uses TWWWsdlClass::getFormatedXml()
	 ...
	 * @uses TWWWsdlClass::getSoapClient()
	 * @uses TWWWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses TWWWsdlClass::getInternArrayToIterate()
	 * @uses TWWWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses TWWWsdlClass::getInternArrayToIterateOffset()
	 * @uses TWWWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses TWWWsdlClass::getInternArrayToIterateOffset()
	 * @uses TWWWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @uses TWWWsdlClass::getAttributeName()
	 * @uses TWWWsdlClass::__toString()
	 * @uses TWWWsdlClass::_set()
	 * @uses TWWWsdlClass::_get()
	 * @uses TWWWsdlClass::setInternArrayToIterate()
	 * @uses TWWWsdlClass::setInternArrayToIterateIsArray()
	 * @uses TWWWsdlClass::setInternArrayToIterateOffset()
