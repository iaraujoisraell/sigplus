<?php
/**
 * File for class TWWStructBuscaSMSMONaoLido
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMSMONaoLido originally named BuscaSMSMONaoLido
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMSMONaoLido extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $Senha;
	/**
	 * Constructor method for BuscaSMSMONaoLido
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @return TWWStructBuscaSMSMONaoLido
	 */
