<?php
/**
 * File for class TWWStructBuscaSMSAgendaDataSet
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMSAgendaDataSet originally named BuscaSMSAgendaDataSet
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMSAgendaDataSet extends TWWWsdlClass
{
	/**
	 * The NumUsu
	 * Meta informations extracted from the WSDL
	...
	public $DS;
	/**
	 * Constructor method for BuscaSMSAgendaDataSet
	 * @see parent::__construct()
	 * @param string $_numUsu
	 * @param string $_senha
	 * @param TWWStructDS $_dS
	 * @return TWWStructBuscaSMSAgendaDataSet
	 */
