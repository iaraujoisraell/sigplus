<?php
/**
 * File for class TWWStructBuscaSMSResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMSResult originally named BuscaSMSResult
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMSResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for BuscaSMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
