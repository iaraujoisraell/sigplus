<?php
/**
 * File for class TWWStructBuscaSMSAgendaDataSetResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMSAgendaDataSetResult originally named BuscaSMSAgendaDataSetResult
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMSAgendaDataSetResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for BuscaSMSAgendaDataSetResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSAgendaDataSetResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSAgendaDataSetResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
