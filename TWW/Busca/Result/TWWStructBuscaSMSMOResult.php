<?php
/**
 * File for class TWWStructBuscaSMSMOResult
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMSMOResult originally named BuscaSMSMOResult
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMSMOResult extends TWWWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for BuscaSMSMOResult
	 ...
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSMOResult::setSchema()
	 ...
	 * @uses DOMDocument::saveXML()
	 * @uses DOMNode::item()
	 * @uses TWWStructBuscaSMSMOResult::setAny()
	 * @param bool true or false whether to return XML value as string or as DOMDocument
	 * @return DOMDocument|null
	 */
