<?php
/**
 * File for class TWWStructBuscaSMS
 * @package TWW
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TWWStructBuscaSMS originally named BuscaSMS
 ...
 * @date 2013-12-04
 */
class TWWStructBuscaSMS extends TWWWsdlClass
{
	/**
	 * The DataIni
	 * Meta informations extracted from the WSDL
