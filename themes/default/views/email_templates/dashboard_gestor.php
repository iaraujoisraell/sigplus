...
<body onload="imprime();">
    ...
    <div id="wrapper">
         ...
         <nav style="width: 100%;"  >
          <p class="text-center"><img width="100%;" height="20%" src="<?= base_url() ?>assets/uploads/logos/cabecalho_unimed.png " ></p>
             </nav> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-title center">
                            ...
                            <h2><p>Relatório de Status do Projeto : </p>
                                <p><?php  echo $projetos->projeto; ?></p></h2>
                            <?php 
                                $users = $this->site->geUserByID($usuario);   
                            
                            ?>
                            <h3>Olá <?php echo $users->first_name .' '. $users->last_name ?></h3>
                            <br>
                            <p>Este é um email automático do sistema de projetos da TI-UnimedManaus, </p>
                                <p>Você recebeu este email, porque alguém da sua equipe tem ações neste projeto.</p>
                                <p>Pedimos que acompanhe as ações da sua equipe e o desempenho da mesma.</p>
                                <br>
                            <h3>
                                <p>Este relatório exibe o desempenho da sua equipe neste projeto. </p> 
                                <p>No link abaixo você pode imprimir o relatório completo.</p></h3>
                            
                            <p><a  href='http://managerprojetos.unimedmanaus.com.br/index.php/Reports/dashboard_pdf/<?php echo $projeto_selecionado ?>/<?php echo $usuario  ?>/<?php echo $perfil_atual ?>'><h3>Imprimir Relatório</h3></a></p>
                           
                            <p> <h3>Ou acessar o sistema, para visualizar o dashboard completo e as ações da sua equipe.</h3></p>
                                
                              <a  href="http://managerprojetos.unimedmanaus.com.br/"><h3>Acessar Sistema</h3></a>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        foreach ($areas_projeto as $area_projeto) {
                                            ...
                                            <div  class="tab-pane fade in active "  id="<?php echo $id_superintendente; ?>">
                                                ...
                                                -->
                                            <?php
                                           // echo 'PERFIL ATUAL '.$perfil_atual;
...
?>       
            ...
            <p> Atenciosamente &nbsp; &nbsp;<br>
   Sistema de Controle de Projetos  <br>
    Escritório de Projetos<br>
    Equipe de TI - UNIMED MANAUS
    <br>
  </p>
            </div>
            <!-- /.page-content -->
