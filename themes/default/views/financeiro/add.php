                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Data 1o. Vencimento", "sldate"); ?>
                                    <input class="form-control input-tip datetime" id="sldate" required="required" name="date" type="date"> 
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('contrato', $bl2, (isset($_POST['contrato']) ? $_POST['contrato'] : $Settings->default_account), 'id="contrato" data-placeholder="' . lang("select") . ' ' . lang("contrato") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('value', (isset($_POST['value']) ? $_POST['value'] : $Settings->default_value), 'maxlength="15" class="form-control input-tip" onkeypress="mascara(this, mvalor);"  id="sldiscount" required="required"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("quantity_plots", "quantidade"); ?>
                                <?php $pst2['1'] = '1';
                                     $pst2['2'] = lang('2');
                                     $pst2['3'] = lang('3');
                                     $pst2['4'] = lang('4');
                                ...
                                echo form_dropdown('quantidade', $pst2, (isset($_POST['quantidade']) ? $_POST['quantidade'] : $Settings->default_slpayment_status), 'id="quantidade" class="form-control " data-placeholder="' . lang("select") . ' ' . lang("quantidade") . '" required="required"   style="width:100%;" '); ?>
