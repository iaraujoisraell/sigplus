...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_despesas'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("financeiro/add", $attrib);
                if ($quote_id) {
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $slnumber), 'maxlength="200" class="form-control input-tip" id="slref"'); ?>
                            </div>
                        </div>
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('account', $bl, (isset($_POST['account']) ? $_POST['account'] : $Settings->default_account), 'id="saccount" data-placeholder="' . lang("select") . ' ' . lang("account") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                echo form_dropdown('provider', $wh2, (isset($_POST['provider']) ? $_POST['provider'] : $Settings->default_supplier), 'id="slcustomer" class="form-control  select" data-placeholder="' . lang("select") . ' ' . lang("provider") . '" required="required" style="width:100%;" ');
                                                ?>
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('description', (isset($_POST['description']) ? $_POST['description'] : $Settings->default_value), 'maxlength="200" class="form-control input-tip" id="sldescription" required="required"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('value', (isset($_POST['value']) ? $_POST['value'] : $Settings->default_value), 'maxlength="15" class="form-control input-tip" id="sldiscount" required="required"'); ?>
                                </div>
                            </div>
                        ...
                        <div class="clearfix"></div>
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('payment_status', $pst, (isset($_POST['payment_status']) ? $_POST['payment_status'] : $Settings->default_slpayment_status), 'id="slpayment_status" class="form-control " data-placeholder="' . lang("select") . ' ' . lang("payment_status") . '" required="required"   style="width:100%;" '); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                               ...
                                               echo form_dropdown('pagament_form', $wh5,  (isset($_POST['pagament_form']) ? $_POST['pagament_form'] : $Settings->default_slpagament_form), 'id="slpagament_form" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("pagament_form") . '"  style="width:100%;" ');
                                      ...
                                      <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                echo form_dropdown('categorie', $ec2, (isset($_POST['categorie']) ? $_POST['categorie'] : $Settings->expense_categories), 'id="slexpense_categories" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("categorie") . '" required="required" style="width:100%;" ');
                                                ?>
                                            </div>
                                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("quantity_plots", "slpayment_term"); ?>
                                <?php echo form_input('quantidade', (isset($_POST['quantidade']) ? $_POST['quantidade'] : $Settings->default_quantidade), 'class="form-control tip" maxlength="2" onkeypress="return SomenteNumero(event)" data-trigger="focus" data-placement="top" value="1" title="' . lang('payment_term_tip') . '" required="required" id="slpayment_term"'); ?>
