<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('financeiro/getSales' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, null, null,{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false}],
            ...
            {column_number: 5, filter_default_label: "[<?=lang('categorie');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('parcela');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-money"></i><?=lang('expenses') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_expenses')) . ')';?>
        </h2>
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=site_url('financeiro/add')?>">
                                <i class="fa fa-plus-circle"></i> <?=lang('add_despesas')?>
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("value_pagar"); ?></th>
                            <th><?php echo $this->lang->line("value_pago"); ?></th>
