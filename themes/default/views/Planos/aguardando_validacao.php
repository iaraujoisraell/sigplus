...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('planos/getPlanosAguardandoValidacao/?v=1'. $v .'&'. ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,null,null, null, null, {"mRender": fld}, null,  {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-clock-o"></i><?=lang('Aguardando Validação') . ' (' .  lang($projetos_usuario->projeto) . ')';?>
        </h2>
...
?>
    ...
    <div id="form">
                    ...
                    <?php echo form_open("planos/planosAguardandoValidacao"); ?>
                    <div class="row">
