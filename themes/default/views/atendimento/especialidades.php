    ...
    <div id="wrapper">
                ...
                <nav style="background-color: <?php echo $projetos->botao; ?>;" class="navbar-top"  role="navigation">
                    ...
                    <div class="box-header">
                        <center>     <h3 >Consulta Prestador / Especialidades</h3> </center>
                        </div>
                </nav>
                                ...
                                <tbody>
                                   ...
                                   $cont = 1;
                                      $especialidades = $this->atas_model->getAllEspecialidadesSai();
                                       ...
                                       $especialidade_descricao = $especialidade->especialidade;  
                                        
                                    ?>
                                    <tr>
                                        <td><?php echo $cont++; ?></td>
                                        <td><?php echo $especialidade_descricao; ?></td>
                                        <td  >
                                            <table>
                                            <?php 
                                            
                                            $prestadores = $this->atas_model->getAllPrestadoresSaiByEspecialidade($especialidade_descricao);
                                            ...
                                            ?>
                                            <tr>
                                                <td ><?php echo '-'. $nome; ?> <?php if($valor){ echo ' ( R$ '. $valor .' ) ';} ?></td>  
                                               <td> <?php echo ' '; ?> <a class="label label-primary" href="<?= site_url('atendimento/prestador_editar/'.$id_prestador); ?>" >Abrir</a> <?php // } ?></td>
                                            </tr>    
                                            <?php
                                            }
                                            ?>
