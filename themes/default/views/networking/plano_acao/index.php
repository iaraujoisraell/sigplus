        ...
        <div class="box-header">
                    <span class="pull-right-container">
                       <div class=" clearfix no-border">
                           <a  title="Cadastrar Nova Tarefa" class="btn bg-olive-active pull-right" href="<?= site_url('welcome/novoPlano/89/55'); ?>" data-toggle="modal" data-target="#myModal">  
                                         ...
                                         <?php
                                            ...
                                            ?>               
                                                ...
                                                <tr  >
                                                    ...
                                                    <td style="width: 15%;">
                                                        <a class="btn bg-primary" title="Plano de Ação"  href="<?= site_url('welcome/plano_acao_detalhes/' .$ata->id); ?>"><i class="fa fa-folder-open"></i>  Abrir </a>
                                                    </td>    
