...
<div  class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Nova Publicação no Mural'); ?></h4>
        </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body pad">
                             <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
                                echo form_open_multipart("welcome/novaPostagem_mural", $attrib); 
                                echo form_hidden('nova_postagem', '1');
                                echo form_hidden('usuario_profile', $usuario_visitante);


                                $date_hoje = date('Y-m-d');   
                                //echo $usuario_visitante;
                            ?>
