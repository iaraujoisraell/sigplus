...
<div  class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Cadastro de '.$titulo.' | Alterar Cadastro'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
            echo form_open_multipart("welcome/editarCadastro", $attrib); 
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group company">
                        ...
                        <?php    }else if($tipo_campo == 'textarea'){ ?>
                              <?php echo form_textarea($campo_banco, (isset($_POST['texto_convocacao']) ? $_POST['texto_convocacao'] : "$dados_tabela->$campo_banco"), 'class="form-control" id="'.$campo_banco.'"   style="margin-top: 10px; height: 150px;"'); ?>
                        <?php }else if($tipo_campo == 'dropdown'){ ?>
                            <?php 
                             ...
                             if($sessao == 'empresa'){
                              ...
                              echo form_dropdown($campo_banco, $pst_fk_campo, (isset($dados_tabela->$campo_banco) ? $dados_tabela->$campo_banco : "$dados_tabela->$campo_banco"), 'id="'.$campo_banco.'"   class="form-control selectpicker  select" data-placeholder="' . lang("N/A") . ' "  style="width:100%;" '); ?>
