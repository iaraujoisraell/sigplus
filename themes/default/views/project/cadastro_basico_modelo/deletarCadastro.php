...
<div  class="modal-dialog">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
            echo form_open_multipart("project/deletarCadastro", $attrib); 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group company">
                        ...
                        <input type="date" class="form-control" disabled name="<?php echo $campo_banco; ?>" value="<?php echo $dados_tabela->$campo_banco; ?>" >
                        <?php }else{ ?>
                        <?php echo form_input($campo_banco, $dados_tabela->$campo_banco, 'class="form-control '.$input.'" disabled maxlength="'.$tamanho.'" id="'.$campo_banco.'"  '.$obrigatorio_texto.' '); ?>
                        <?php } ?>
