            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div style="text-align: right">
                                 <div  class="col-md-12">
                                     <a  style="width:50px; height: 50px; " class="btn btn-danger" class="close" data-dismiss="modal" > <div style="margin-top: 8px;"></div> <i class="fa fa-close"></i>  </a>  
                                </div>
                            </div> 
                    <br>
                    <div style="margin-left: 10px; margin-right: 10px;" class="row pricing-circle">
                            ...
                            <div style="float: left; margin-top: -230px;" class="col-md-9">
                             ...
                             <center>
                                 <div  class="col-md-12">
                                 <a  style="width:150px; height: 50px; " class="btn btn-danger" class="close" data-dismiss="modal" > <div style="margin-top: 8px;"><?= lang('Fechar ') ?></div>  </a>  
                                </div>
                            </center>
