...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('planos/getPlanosPendentes/?v=1'. $v .'&'. ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, {"mRender": fld}, null,  {"bSortable": false}],
            ...
            {column_number: 6, filter_default_label: "[<?=lang('Quando');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-clock-o"></i><?=lang('Pendentes') ;?>
        </h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("Planos/planosPendentes"); ?>
                    <div class="row">
