...
<body>
                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4>QUANTIDADE DE CADASTROS REVISADOS</h4>
                                </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div style="height: 330px;" class="tile blue  dash-demo-tile">
                                                                <h4><i class="fa fa-sitemap fa-fw"></i> Medicamentos </h4>
                                                                
                                                                <?PHP
                                                                $afazer = 142;//330;  69
                                                                $concluido = 687;// 623 + 64  =684
                   ...
                   <!-- LADO ESQUERDO -->
                    <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4>DESEMPENHO DE CONCLUSÃO DE CADASTROS POR DIA</h4>
                                </div>
                                <div class="portlet-widgets">
                                    <a href="#"><i class="fa fa-gear"></i></a>
                                    <span class="divider"></span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="portlet portlet-green">
                            ...
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4>Desempenho dos reajustes </h4>
                                </div>
                                <div class="portlet-widgets">
                                    <a href="javascript:;"><i class="fa fa-refresh"></i></a>
                                    <span class="divider"></span>
   ...
   <!-- GLOBAL SCRIPTS -->
    ...
    data: [
      ...
      { d: '2018-05-23', Concluído: 83 }, // 7 + 60 
      { d: '2018-05-22', Concluído: 70 }, // 7 + 60 
      { d: '2018-05-21', Concluído: 63 }, // 7 + 60 
      { d: '2018-05-18', Concluído: 62 }, // 7 + 60 
      { d: '2018-05-17', Concluído: 65 }, // 7 + 60      
      { d: '2018-05-16', Concluído: 55 }, // 2 + 18     
      { d: '2018-05-15', Concluído: 130 }, // 2 + 18     
      { d: '2018-05-14', Concluído: 62 }, // 2 + 18     
      { d: '2018-05-11', Concluído: 80 }, // 2 + 18     
        
      { d: '2018-05-10', Concluído: 71 }, // 7 + 60 
      { d: '2018-05-09', Concluído: 56 }, // 7 + 60 
      { d: '2018-05-08', Concluído: 46 }, // 7 + 60 
      { d: '2018-05-07', Concluído: 67 }, // 7 + 60      
      { d: '2018-05-04', Concluído: 44 }, // 2 + 18     
      { d: '2018-05-03', Concluído: 26 }, // 2 + 18     
      { d: '2018-05-02', Concluído: 0 }, // 2 + 18     
      { d: '2018-04-30', Concluído: 8 }, // 2 + 18     
      { d: '2018-04-27', Concluído: 20 }, // 2 + 18      
      { d: '2018-04-24', Concluído: 75 }, // 0 + 75    
      { d: '2018-04-23', Concluído: 66 }, // 0 + 66  
      { d: '2018-04-20', Concluído: 73 }, // 16 + 57
      { d: '2018-04-19', Concluído: 93 }, // 7 + 86
      { d: '2018-04-18', Concluído: 22 }, // 2 + 20
      { d: '2018-04-17', Concluído: 89 }, //
      { d: '2018-04-16', Concluído: 95 }, //
      { d: '2018-04-13', Concluído: 76 }, // 
      { d: '2018-04-12', Concluído: 92 }, //
      { d: '2018-04-11', Concluído: 19 }, // 
