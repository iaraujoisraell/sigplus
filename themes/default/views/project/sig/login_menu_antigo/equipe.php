                                                ...
                                                <td class="center"> 
                                                    <table style="width: 100%;" id="example-table" class="table table-striped table-bordered table-hover table-green">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:left; width: 30%;"><?php echo $membro->descricao; ?></td>
                                                            <td>
                                                                <a  href="<?= site_url('Login_Projetos/abrir_rat/'.$membro->id); ?>"  class="btn btn-block  btn-lg " style="background-color: gray; color: #ffffff;">
                                                                        RAT'S
                                                                </a>
                                                            </td>
