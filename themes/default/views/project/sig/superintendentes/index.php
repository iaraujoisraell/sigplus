...
?>
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-list"></i><?=lang('Lista de Superintendentes') ;?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr   class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <table>
                                                                    <?php
                                                                    $setores_vinculadas = $this->site->getAllAreasVinculadas($plano->users,$projeto_atual );
                                                                    ...
                                                                    foreach ($setores_vinculadas as $setor_vinculado) {
                                                                        ...
                                                                        <tr>
                                                                            <td class="center">
                                                                                 <?php echo $setor_vinculado->superintendencia; ?> 
                                                                            </td>
                                                                        </tr>
                                                             <?php 
                                                                        }else{
                                                        ...
                                                        <td class="center">
                                                            <a style="background-color: chocolate; color: #ffffff;" class="btn fa fa-edit"  href="<?= site_url('gestores/edit_superintendente/'.$plano->users); ?>"> </a>
                                                        </td>
