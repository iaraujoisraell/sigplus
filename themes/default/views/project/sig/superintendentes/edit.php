...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Vincular a(s) Área(s) ao Superintendente'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("gestores/edit_superintendente/" . $id, $attrib); ?>
        <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                foreach ($setores_vinculados as $setor_vinculado) {
                                   ...
                                   $wp[$setor_vinculado->sup_id] = $setor_vinculado->sup_id;     
          ...
          <div
                                class="fprom-group"><?php echo form_submit('add_projeto', lang("submit"), 'id="add_projeto" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
                                 <a  class="btn btn-danger" href="<?= site_url('Gestores/superintendentes'); ?>"><?= lang('Cancelar') ?></a>
                        </div>  
