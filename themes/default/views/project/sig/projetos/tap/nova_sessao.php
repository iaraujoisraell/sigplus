        ...
        font-size: 11px;
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header"><p class="introtext">DOCUMENTAÇÃO - NOVA SESSÃO</p>
                            ...
                            <div class="modal-body">
                               ...
                               <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                                echo form_open_multipart("Projetos/add_tap_sessao" , $attrib); 
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_textarea('descricao', (isset($_POST['descricao']) ? $_POST['descricao'] : ""), 'class="form-control" id="slcomentarioIndicadores"  style="margin-top: 10px; height: 150px;"'); ?>
                                    </div>
                            ...
                            <?php echo form_submit('add_projeto', lang("Adicionar"), 'id="add_projeto" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
                                            <a  class="btn btn-danger" href="<?= site_url('projetos/tap/'.$id); ?>"><?= lang('Voltar') ?></a>
                                </div>
                                    <?php echo form_close(); ?>
                            </div>
