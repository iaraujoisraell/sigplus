    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("cadastros/add_equipe", $attrib);
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo form_input('nome', (isset($_POST['nome']) ? $_POST['nome'] : $slnumber), 'maxlength="250" class="form-control input-tip" required="required" id="slprojeto"'); ?>
                            </div>
