...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Lista de Usuários para vincular a ATA'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("atas/edit_usuarios_vinculados/$ata" , $attrib); ?>
            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
                    ...
                    foreach ($participantes as $participante) {
                         ...
                         $usuario_cadastrados_ata = $this->atas_model->getAtaUserByID_ATA($ata, $participante->id_user );
                          
                        ?>
                        <div class="col-md-12">

                            <input type="checkbox" name="usuarios_vinculos[]" <?php if($usuario_cadastrados_ata){ ?> checked <?php } ?>   value="<?php echo $participante->id_user; ?>"><?php echo '  ' . $participante->fname . ' - ' . $participante->lname . ' - ' . $participante->setor . ';'; ?>
