        ...
        <div class="box-header">
            <span class="pull-right-container">
               <div class=" clearfix no-border">
                   <a  title="Cadastrar Nova Fase" class="btn btn-primary pull-right" href="<?= site_url('project/novoCadastroFase/'.$tabela_id."/".$menu_id.'/fases_projetos'); ?>" data-toggle="modal" data-target="#myModal">  
                   <i class="fa fa-plus"></i>   Cadastrar Fase
                   </a> 
                                 ...
                                 <?php
                                    ...
                                    <li>
                                       <div class="box box-success collapsed box-solid">
                                                ...
                                                <br>
                                                <div class="col-lg-12">
                                                <a style="color: #ffffff;" title="<?php echo 'Cadastrar Novo Evento'; ?>" class="btn btn-primary fa fa-plus pull-right" href="<?= site_url($controler_fase.'/'.$funcao_add_evento.'/'.$tabela_evento.'/'.$id_fase.'/'.$menu_id_evento.'/fases_projetos'); ?>" data-toggle="modal" data-target="#myModal"> Adicionar Evento </a>
                                                </div>
                                                <br><br>
                                                                    ...
                                                                    <div id="<?php echo $id_evento; ?>" class="box-body">
                                                                         ...
                                                                         <div class="portlet-body">
                                                                             <div class="table-responsive">
                                                                                ...
                                                                                <thead>
                                                                                    <tr>
                                                                                        <td style="  font-size: 16px; font-weight: bold; "> Itens </td>
                                                                                    </tr>
                                                                                </thead>
                                                                                    <?php
