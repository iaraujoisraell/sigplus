    ...
    <div class="modal-content">
        <div class="modal-header">
           <a type="button" class="close" onclick="history.go(-1)" aria-hidden="true"><i class="fa fa-2x">&times;</i>
            ...
            $dt_final = $projetos->dt_final;
            $nome_projeto = $projetos->nome_projeto;
            ?>
            <h4 class="modal-title" id="myModalLabel"><?php echo lang($nome_fase).'  | Editar Cadastro'; ?></h4>
                ...
                <div class="col-md-12">
                    <div class="form-group company">
                         <?= lang("Nome do Evento", "evento"); ?>
                          <?php echo form_input('evento', $nome_fase,  'class="form-control input" title="Nome do Evento da Fase" maxlength="250" id="evento"  required="required" '); ?>
                    ...
                    <div class="form-group company">
                       <?= lang("Responsável ", "responsavel"); ?>
                            <?php 
                              ...
                              echo form_dropdown('responsavel', $pst_fk_campo, (isset($_POST['reacao']) ? $_POST['reacao'] : $responsavel), 'id="responsavel"  required="true" title="O Responsável pelo Evento, é a pessoa que irá responder ou representar por este evento. Irá fornecer informações sobre o anadamento do evento." class="form-control selectpicker  select" data-placeholder="' . lang("N/A") . ' "  style="width:100%;" ');
