<?php
$fase_dados = $this->projetos_model->getEventoByID($evento_id);
$nome_fase = $fase_dados->nome_evento;
...
?>
  ...
  <script type="text/javascript">
    ...
    <section class="content-header">
                    <h1> <?php echo 'Re-ordernar os itens do evento '.$nome_fase ; ?></h1>    
                  
                  <ol class="breadcrumb">
                    <li><a href="<?= site_url('project'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Escopo</li>
                    <li class="active">Ordernar Itens</li>
                  </ol>
                </section>
       ...
       <div class="box">       
        ...
        <div class="box box-primary">
            ...
            <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
                echo form_open_multipart("project/organizarItemEventos", $attrib); 
                //echo form_hidden('fase', $fase); 
                echo form_hidden('ordernar_item', '1'); 
            ?>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <ul class="todo-list">
                   <?php
                    $wu4[''] = '';
                    $cont_lista = 1;
                    foreach ($eventos_itens as $cadastro) {
                        $id_fase =  $cadastro->id;
                        $nome_fase =  $cadastro->descricao;
                    ?>     
