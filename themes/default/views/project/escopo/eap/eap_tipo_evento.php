                                                            ...
                                                            <div class="tree">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <ul>
                                                                            <?php
                                                                              $ordem = 'ordem';
                                                                                 $eventos = $this->projetos_model->getAllEventosProjetoByTipo($tipo, $id_projeto , $ordem,'asc');
                                                ...
                                                <br><br><br><br><br>
                                                    ...
                                                    <li>
                                                        <a href="#"><?php echo $tipo; ?></a>
                                                            ...
                                                            <?php
                                                             $ordem = 'ordem';
                                                             $eventos = $this->projetos_model->getAllEventosProjetoByTipo($tipo, $projetos->projeto_atual , $ordem,'asc');
                                                             foreach ($eventos as $evento) {
                                                            ?>
                                                            <ul>
