                ...
                <div class="row">
                    ...
                    <div style="margin-left: 10px; margin-right: 10px;" class="row pricing-circle">
                            ...
                            <div style="float: left; margin-top: -200px;" class="col-md-9">
                             ...
                             <center>
                                 <div  class="col-md-12">
                                 <a  style="width:150px; height: 50px; " class="btn btn-danger" href="<?= site_url('Login_Projetos/eventos_acoes/'.$acao->eventos); ?>"> <div style="margin-top: 8px;"><?= lang('Fechar ') ?></div>  </a>  
                                </div>
                            </center>
