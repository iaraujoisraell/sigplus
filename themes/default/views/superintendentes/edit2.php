                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("Elaboração da ATA", "slelaboracao"); ?>
                                <?php if($statusAta == 1){ ?>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('avulsa', $pst2, (isset($_POST['avulsa']) ? $_POST['avulsa'] : $ata->avulsa), 'id="avulsa" class="form-control " data-placeholder="' . lang("Selecione") . ' " required="required"   style="width:100%;" ');
                                ?>
