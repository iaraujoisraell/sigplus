                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('setor[]', $gp2, (isset($_POST['setor']) ? $_POST['setor'] : ''), 'id="group" required="required" multiple class="form-control select" style="width:100%;" data-placeholder="' . lang("Selecione o(s) Setor(es) do usuario") . ' " ');
                                ?>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="form-group">
                                <?php echo lang('Matrícula', 'matricula'); ?>
                                <div class="controls">
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('group[]', $gp, (isset($_POST['group']) ? $_POST['group'] : ''), 'id="perfil" required="required" multiple class="form-control select" style="width:100%;" data-placeholder="' . lang("Click e selecione o(s) Perfil(is) do usuario") . ' " ');
                                ?>
                            </div>
