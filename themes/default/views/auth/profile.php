                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo form_input('first_name', $user->first_name, 'class="form-control" id="first_name" disabled required="required"'); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo form_input('last_name', $user->last_name, 'class="form-control" id="last_name" disabled required="required"'); ?>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo form_input('company', $user->company, 'class="form-control"  id="company" disabled'); ?>
                                                    </div>
                                                </div>
                                           
                                            <?php if (($Owner || $Admin) && $id != $this->session->userdata('user_id')) { ?>
                                            <div class="form-group">
                                                <?= lang('Superintendência', 'award_points'); ?>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            foreach ($groups as $group) {
                                                                              ...
                                                                              foreach ($users_perfil as $user_perfil) {
                                                    
                                                                                $wua[$user_perfil->grupo_id] = $user_perfil->grupo_id;
                                                                                
                                                                            } 
                                                                           // print_r($users_perfil);
                                                                            echo form_dropdown('group[]', $gp, (isset($_POST['group']) ? $_POST['group'] : $wua), 'id="group" multiple data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                                                            ?>
                                                                        </div>
