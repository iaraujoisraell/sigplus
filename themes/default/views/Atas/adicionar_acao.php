...
<div class="box">
    <div class="box-header">
       ...
       <?php $date_cadastro = date('Y-m-d');               
        $data_entrega = date('d/m/Y', strtotime($date_cadastro)); // $this->sma->hrld($date_cadastro); ?>
...
<?php
        ...
        <div class="box-content">
            <div class="row">
                            ...
                            <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang("Data Início  ", "sldateEntregaDemanda"); ?>
                                        <input type="date" name="dateEntregaDemanda" class="form-control" value="<?php echo $date_cadastro; ?>" required="required" id="sldateEntregaDemanda">
                                         <?php // echo form_input('dateEntregaDemanda', (isset($_POST['dateEntregaDemanda']) ? $_POST['dateEntregaDemanda'] : $data_entrega), 'class="form-control input-tip date" id="sldateEntregaDemanda" required="required"'); ?>
                                        </div>
                                </div>
                                
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang("Prazo Término ", "sldate"); ?>
                                           <input type="date" name="dateEntrega" class="form-control" value="<?php echo $date_cadastro; ?>" required="required" id="dateEntrega">
                                    
                                             <?php // echo form_input('dateEntrega', (isset($_POST['dateEntrega']) ? $_POST['dateEntrega'] : $data_entrega ), 'class="form-control input-tip date" id="sldate" required="required"'); ?>
                                    </div>
                                </div>
