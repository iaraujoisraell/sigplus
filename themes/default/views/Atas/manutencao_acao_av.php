            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div style="text-align: right">
                                 <div  class="col-md-12">
                                     <a  style="width:50px; height: 50px; " class="btn btn-danger" href="<?= site_url('Atas/plano_acao/'.$acao->idatas); ?>"> <div style="margin-top: 8px;"></div> <i class="fa fa-close"></i>  </a>  
                                </div>
                            </div> 
                    <br>
                                        ...
                                        <li style="height: 35px;" class="plan-name">
                                            ...
                                            <div class="col-md-12"  >
                                                ...
                                                <?php
                                                    ...
                                                    echo form_dropdown('responsavel', $wu41, (isset($_POST['responsavel']) ? $_POST['responsavel'] : $acao->responsavel), 'id="slResponsavel"  class="form-control  select" data-placeholder="' . lang("Selecione o Responsável") . ' " disabled   required="required"');
                                                ?>
                                                </div>
                                            </div>
                                        </li>
