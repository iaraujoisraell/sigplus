                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="dateEntregaDemanda" class="form-control" value="<?php echo $acao->data_entrega_demanda; ?>" required="required" id="sldateEntregaDemanda">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang("Prazo Término ", "sldate"); ?>
                                           <input type="date" name="prazo" class="form-control" value="<?php echo $acao->data_termino; ?>" required="required" id="prazo">
