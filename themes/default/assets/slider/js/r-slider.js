...
function slider(config) {
    var a = {
        ...
        getClient: function (e, axis) { if (this.state.isMobile) { return e.changedTouches[0]["client" + axis]; } else { return e["client" + axis]; } },
        ...
        eventHandler: function (selector, event, action) {
            if (this.state.isMobile) { if (event === "mousedown") { event = "touchstart"; } else if (event === "mousemove") { event = "touchmove"; } else if (event === "mouseup") { event = "touchend"; } }
