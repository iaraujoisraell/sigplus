...
<script>
        function exibe_like_post_unico(post, usuario) {
                 $.ajax({
                type: "POST",
                url: "themes/default/views/networking/profile/exibe_todos_like_postagem_profile.php",
                data: {
                      usuario: usuario,
                      post: post
                    },
...
<div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php if($avatar){ echo $avatar_profile; }else{ echo $avatar_genero; }?> " alt="User Image">
                        <span class="username">
                          <a ><?php echo $nome; ?></a>
                          <a style="cursor:pointer;" onclick="exibe_mural_profile(<?php echo $usuario; ?>)" class="pull-right btn-box-tool"><i title="Retornar" class="fa fa-reply"></i></a>
                        </span>
