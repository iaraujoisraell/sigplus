    ...
    <section class="content-header">
        <h1>
            <?php echo $titulo; ?>
            <small> <i class="fa fa-info-circle" title="São Atas que você tem permissão de acesso."></i> </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= site_url('welcome'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Atas Vinculadas</li>
        </ol>
    </section>
            ...
            <div class="row">
                        ...
                        <div class="box">
                            ...
                            <div class="table-responsive">
                                <div class="box-body">
                                    <table style="width: 100%;" id="atas_vinculadas" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                                ...
                                                <tr  >
                                                    ...
                                                    <td style="width: 15%; font-size: 12;">
                                                        <div class="text-center"><div class="btn-group text-left">
                                                            ...
                                                            <li><a title="Ver ATA"  href="<?= site_url('welcome/plano_acao_vinculada/'.$ata->id); ?>"><i class="fa fa-list"></i>  ATA </a></li>
