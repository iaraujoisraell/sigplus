<div  class="modal-dialog">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Concluir Tarefa'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'add-customer-form');
            echo form_open_multipart("welcome/ConcluirTarefas", $attrib); 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group company">
                        ...
                        <?php }else{ ?>
                        <?php echo form_input($campo_banco, $dados_tabela->$campo_banco, 'class="form-control '.$input.'" readonly="true" maxlength="'.$tamanho.'" id="'.$campo_banco.'"  '.$obrigatorio_texto.' '); ?>
                        <?php } ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_customer', lang('Confirmar'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
            <!-- /.modal-content -->
