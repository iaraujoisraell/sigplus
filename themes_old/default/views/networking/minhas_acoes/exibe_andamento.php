...
<br>
 <div class="row">
    ...
    <div class="col-md-2">
        <input title="Porcentagem de conclusão da ação." style="width: 60px; height: 30px;  font-size: 14px;" maxlength="3" id="andamento" type="number" value="<?php echo $andamento_plano; ?>" placeholder="0%" > <font style="font-size: 8px;"></font>
        <a onclick="atualiza_andamento(<?php echo $id_plano; ?>, document.getElementById('andamento').value, 1)" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
    </div> 
