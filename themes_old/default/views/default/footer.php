<footer style="background-color: seagreen; position: fixed; bottom: 0px; right: 0px; width: 100%; ">
<a href="#" id="toTop" class="blue" style=" font-size: 30px; display: none;">
    <i class="fa fa-chevron-circle-up"></i>
</a>

    <p style="text-align:center;">&copy; <?= date('Y') . " ESCRITÓRIO DE PROJETOS UNIMED MANAUS "  ?> (v<?= $Settings->version; ?>
        ) <?php 
