                ...
                <div class="box-header">
                    <span class="pull-right-container">
                       <div class=" clearfix no-border">
                           <a style="background-color: green; color: #ffffff;" title="Novo Registro" class="btn btn-default pull-right" href="<?= site_url("owner/novoCadastroBasico/".$tabela_id."/".$menu_id); ?>" data-toggle="modal" data-target="#myModal">  
