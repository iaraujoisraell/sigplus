            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group company">
                        ...
                        <input type="date" class="form-control" <?php echo $obrigatorio_texto; ?> name="<?php echo $campo_banco; ?>" value="<?php echo $dados_tabela->$campo_banco; ?>" >
                        <?php }else{ ?>
                        ...
                        <?php }else if($tipo_campo == 'dropdown'){ ?>
                            <?php 
                             ...
                             if($sessao == 'empresa'){
                              ...
                              echo form_dropdown($campo_banco, $pst_fk_campo, (isset($_POST['reacao']) ? $_POST['reacao'] : ""), 'id="'.$campo_banco.'" '.$obrigatorio_texto.'  class="form-control selectpicker  select" data-placeholder="' . lang("N/A") . ' "  style="width:100%;" ');
