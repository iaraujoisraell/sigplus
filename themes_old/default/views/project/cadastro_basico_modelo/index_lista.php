    ...
    <div class="box-header">
        <span class="pull-right-container">
            <div class=" clearfix no-border">
                <a  title="Novo Registro" class="btn btn-default pull-right" href="<?= site_url('project/novoCadastroBasico/' . $tabela_id . "/" . $menu_id); ?>" data-toggle="modal" data-target="#myModal">  
