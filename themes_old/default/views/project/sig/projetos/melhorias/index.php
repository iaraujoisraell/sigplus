...
function ordenatop(ordem){
    ...
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-calendar-o"></i><?=lang('Melhorias Alcançadas no Projeto');?>
        </h2>
        
        <div id="eventos_index" class="box-icon">
           <div class="fprom-group">
            <a class="btn btn-primary" data-toggle="modal" data-target="#myModal" href="<?=site_url('projetos/add_melhorias')?>"> 
             <i class="fa fa-plus-circle"></i>   <?=lang('Nova Melhoria')?>
            </a>
          </div>
        </div>
    </div>
                                    ...
                                    <table id="sample_table"  class="table table-striped table-bordered table-hover table-green">
                                        ...
                                        <tbody>
                                            ...
                                            <tr   class="odd gradeX">
                                                        ...
                                                        <td><?php echo $evento->mes; ?></td>
                                                        <td><?php echo $evento->ano; ?></td>
                                                        <th><?php echo $evento->titulo; ?></th> 
                                                        <th><?php echo $evento->melhoria; ?></th>  
                                                        ...
                                                        <td class="center">
                                                            <a style="color: #D37423;" class="btn fa fa-edit" data-toggle="modal" data-target="#myModal" href="<?= site_url('projetos/edit_melhorias/'.$evento->id); ?>"></a>
                                                        </td>
                                                         <td class="center">
                                                           <a style="color: red;" class="btn fa fa-trash-o" href="<?= site_url('projetos/delete_melhoria/'.$evento->id); ?>"></a>
