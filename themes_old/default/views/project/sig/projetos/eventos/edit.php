                        ...
                        <div class="col-sm-4">
                                <div class="form-group">
                                 <?= lang("Data Início", "start_date"); ?>
                                    <input type="date" name="dateInicial" value="<?php echo substr($evento->data_inicio,0,10); ?>" id='dateFim' class="form-control">
                                  </div>
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <?= lang("Data Término", "dateEntregaDemanda"); ?>
                                        <input type="date" name="dateFim"  id='dateFim' class="form-control" value="<?php echo substr($evento->data_fim,0,10); ?>">
                                 </div>
