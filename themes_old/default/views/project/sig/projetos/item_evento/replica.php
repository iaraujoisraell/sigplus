                ...
                <?php $evento_selecionado = $this->projetos_model->getEventoByID($evento); ?> 
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header"><p class="introtext">REPLICAR OS ITENS DO EVENTO - <?php echo $evento_selecionado->nome_evento ?>  </p>
                            ...
                            <div class="modal-body">
                               ...
                               <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                                 echo form_open_multipart("Projetos/replica_item_evento" , $attrib); 
                                ...
                                ?>
                                   ...
                                   <div class="fprom-group">
                                    <?php echo form_submit('add_projeto', lang("Replicar"), 'id="add_projeto" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
