            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div style="text-align: right">
                                 <div  class="col-md-12">
                                     <a  style="width:50px; height: 50px; " class="btn btn-danger" href="<?= site_url('Planos/planosConcluidos'); ?>"> <div style="margin-top: 8px;"></div> <i class="fa fa-close"></i>  </a>  
                                </div>
                            </div> 
                    <br>
                    <div style="margin-left: 10px; margin-right: 10px;" class="row pricing-circle">
                            ...
                            <?php //historico ?>   
                            <div  class="col-md-3">
                                    <ul style="background-color: darkgray; height: 450px; overflow:scroll ;  " class="plan plan2 featured">
                                    <li class="plan-name">
                                        <h3>Histórico</h3>
                                        <div class="col-md-12"  >
                                            <div class="form-group">
                            ...
                            <?php //OBS ?>    
                                    ...
                                    <li style="height: 150px;" class="plan-name">
                                        ...
                                        <div class="col-md-12"  >
                                            <div class="form-group">
                                                ...
                                                <?php echo form_textarea('observacao', (isset($_POST['observacao']) ? $_POST['observacao'] :  $acao->observacao), 'class="form-control"  id="slpauta" disabled style="height: 120px;" equired="required" '); ?>
                             ...
                             <center>
                                 <div  class="col-md-12">
                                 <a  style="width:150px; height: 50px; " class="btn btn-danger" href="<?= site_url('Planos/planosConcluidos'); ?>"> <div style="margin-top: 8px;"><?= lang('Fechar ') ?></div>  </a>  
                                </div>
                            </center>
