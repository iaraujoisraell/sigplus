                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                     ...
                                     <h3>EDITAR R.A.T. (Regitro de Atividade de Trabalho)</h3>
                                                    ...
                                                    ?>
                                                     ...
                                                     <?php
                                                        ...
                                                        <?php
                                                            ...
                                                            echo form_open_multipart("welcome/update_rat", $attrib);
                                                            echo form_hidden('id_membro', $id);
                                                            echo form_hidden('rat', $rat);
                                                        ?>
                                                                ...
                                                                <?php
                                                                        ...
                                                                        //$wu4[''] = 'Selecione a Fase/Evento que se refere a RAT';
                                                                          ...
                                                                          $cont_evento = 1;
                                                                            ...
                                                                            foreach ($eventosRat as $eventoRat) {
                                                                                $wu7[$eventoRat->item] = $eventoRat->item;
                                                                            }
                                                                            
                                                                            foreach ($intes_eventos as $item) {
                                                                                    $wu4[$item->id] = $item->id.' - '. $item->fase.' / '. $item->evento.' - '. resume($item->item, 100);
                                     
                                                                            }
                                                                            
                                                                          
                                                                     
                                                                                 echo form_dropdown('eventos_item[]', $wu4, (isset($_POST['eventos_item']) ? $_POST['eventos_item'] : $wu7), 'id="slResponsavel"  class="form-control  select" data-placeholder="' . lang("Selecione") . ' "  style="width:100%; height: 200px;" multiple ');
                                                        ...
                                                        <div class="col-lg-12">
                                                             <div class="col-lg-2">
                                                                <h4>3 - Data</h4>
                                                                <input type="date" name="data_registro" required="true" value='<?php echo $dados_rat->data_rat; ?>' class="form-control" placeholder="Data RAT">
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <h4>4 - H. Início</h4>
                                                                <input type="time" name="hora_inicio" required="true" value='<?php echo $dados_rat->hora_inicio; ?>' class="form-control" placeholder="Hora Início">
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <h4>5 - H. Término</h4>
                                                                <input type="time" name="hora_termino" required="true" value='<?php echo $dados_rat->hora_fim; ?>' class="form-control" placeholder="Hora Término">
                                                            </div>
                                                            
                                                            <div class="col-lg-4">
                                                                <h4>76 - Descrição da Atividade</h4>
                                                                 <textarea  rows="10" name="conteudo" required="true" class="form-control" placeholder="Descreva a Atividade">
                                                                    <?php echo $dados_rat->descricao; ?>
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        <center>
