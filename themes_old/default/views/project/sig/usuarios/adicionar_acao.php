            ...
            <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <center>
                                        <h2> NOVA AÇÃO DO TREINAMENTO DA ATA <?php echo $ata; ?>  </h2>
                                    </center>
                                </div>
                            </div>
                              <div id="blanket"></div>
                            ...
                            echo form_open_multipart("welcome/adcionar_acao_form/".$ata, $attrib);
                            echo form_hidden('id_ata_facilitador', $ata_facilitador);
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      foreach ($eventos as $evento) {
                                        ...
                                        echo form_dropdown('evento', $wue, (isset($_POST['evento']) ? $_POST['evento'] : ""), 'id="slEvento"  class="form-control  select" data-placeholder="' . lang("Selecione o Evento da Ação") . ' "  style="width:100%;"  required="required"');
                                        ?>
                                    </div>
                                </div>
                                </div>
