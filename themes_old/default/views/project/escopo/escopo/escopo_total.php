                                 ...
                                 <li style="background-color: #ffffff;" class="save" id=item-<?php echo $regAnalise->id; ?>>
                                      ...
                                      <div class="box box-default collapsed-box box-solid">
                                          <div style="background-color: #ffffff;" class="box-header with-border">
                                                  ...
                                                  <div id="result_fase<?php echo $regAnalise->id; ?>">
                                                  <span class="handle">
                                                    <i class="fa fa-ellipsis-v"></i>
                                                    <i class="fa fa-ellipsis-v"></i>
                                                  </span>
                                                      <h3 class="box-title"><?php echo $regAnalise->nome_fase; ?> </h3> De <?php echo date("d/m/Y", strtotime($projetos->dt_inicio)); ?>
                                                      Até <?php echo date("d/m/Y", strtotime($projetos->dt_final)); ?>  </div>
                                             
                                                 <br>
                                                 <div id="container_fase<?php echo $regAnalise->id; ?>"></div>
                                                ...
                                                <script>
                                                    var A = new slider({
                                                        ...
                                                        value: [<?php echo $qtde_dias_inicio; ?>, <?php echo $qtde_dias_fim; ?>],
                                                        container: "#container_fase<?php echo $regAnalise->id; ?>",
                                                        ondrag: showResult,
                                                        labelStep: 30,
                                                        style: { line_width: 10, button_width: 24, button_height: 24}
                                                    });
                                                    ...
                                                    function showResult(obj) {
                                                      // 
                                                       ...
                                                       <?php $dias_de = "<script>+obj.value[0]+</script>" ?> ;
                                                          //      alert(obj.value[0]);
                                                         $("#result_fase<?php echo $regAnalise->id; ?>").html("Previsto De " +  adicionarDiasData_de(obj.value[0])   + " Até " + obj.value[1]);
                                                    }
