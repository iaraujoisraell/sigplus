...
<div  class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div style="background-color: red; color: #ffffff;" class="modal-header">
            ...
            <H5>Este cadastro, não pode ser apagado! 
                <br>Pois possuem ações vinculados a seus itens!</H5>
        </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_customer', lang('Inativar Eventos e Ações'), 'class="btn btn-danger"'); ?>
        </div>
    </div>
