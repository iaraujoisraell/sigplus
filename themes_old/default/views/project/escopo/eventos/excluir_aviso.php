...
<div  class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div style="background-color: red; color: #ffffff;" class="modal-header">
            <h4>AVISO IMPORTANTE!</h4>
            <H5>Este cadastro, possui itens de evento vinculado a ele. 
                <br>Se deletar este cadastro, todos os itens serão apagados!</H5>
            <table>
                <tr>
                    <td><font style="color: #ffffff;">ITENS : </font></td>
                </tr>
            <?php
            $intes_eventos  = $this->projetos_model->getItemEventosByProjeto($evento);
            foreach ($intes_eventos as $item) {
            ?>
            
                <tr>
                    <td><font style="color: #ffffff;"><?php echo $item->descricao; ?></font></td>
                </tr>
