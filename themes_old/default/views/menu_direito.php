...
<!-- Control Sidebar -->
  <aside class="control-sidebar control-sidebar-dark active">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      ...
      <li><a href="#modulos-tab" title="Módulos" data-toggle="tab"><i class="fa fa-puzzle-piece"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane" id="modulos-tab">
        <form method="post">
          <h3 class="control-sidebar-heading">Módulos</h3>

          <ul class="sidebar-menu" data-widget="tree">
         
            <li>
              <a href="<?= site_url('Owner'); ?>">
